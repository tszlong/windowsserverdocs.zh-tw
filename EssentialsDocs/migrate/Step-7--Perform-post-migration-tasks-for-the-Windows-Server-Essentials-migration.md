...
1.  [刪除來源伺服器的 DNS 專案](Step-7--Perform-post-migration-tasks-for-the-Windows-Server-Essentials-migration.md#BKMK_DeleteDNSEntries)  
  
2.  [共用企業營運和其他應用程式資料檔案夾](Step-7--Perform-post-migration-tasks-for-the-Windows-Server-Essentials-migration.md#BKMK_ShareLineOfBusinessAndOtherApplications)  
...
## <a name="next-steps"></a>後續步驟  
 您已執行 Windows Server Essentials 遷移的遷移後工作。 現在請移至[步驟 8--執行 Windows Server Essentials 最佳做法分析程式](Step-8--Run-the-Windows-Server-Essentials-Best-Practices-Analyzer.md)。  
