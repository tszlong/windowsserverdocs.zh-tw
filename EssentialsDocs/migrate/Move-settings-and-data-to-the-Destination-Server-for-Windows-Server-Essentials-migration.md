---
title: "前往目的地 Windows Server Essentials 伺服器移轉的設定和資料"
...
---
# <a name="move-settings-and-data-to-the-destination-server-for-windows-server-essentials-migration"></a>前往目的地 Windows Server Essentials 伺服器移轉的設定和資料
...
2.  [設定網路](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_Network)  
  
3.  [允許電腦帳號地圖](Move-Windows-SBS-2008-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md#BKMK_MapPermittedComputers)  
