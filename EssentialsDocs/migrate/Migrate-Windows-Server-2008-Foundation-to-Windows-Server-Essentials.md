...
本指南說明如何將現有的 Windows Server 2008 Foundation 網域遷移至 &reg; 新硬體上的 Windows server 2012 Essentials，然後遷移設定和資料。 本指南也說明如何在完成遷移之後，從 Windows Server Essentials 網路移除現有的伺服器。
