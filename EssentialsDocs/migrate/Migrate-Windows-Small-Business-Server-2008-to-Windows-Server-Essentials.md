...
本指南說明如何在新的硬體上將現有的 Windows SBS 2008 網域遷移至 Windows Server &reg; 2012 Essentials，然後遷移設定和資料。 本指南也說明如何在完成遷移之後，從 Windows Server Essentials 網路移除現有的伺服器。  
