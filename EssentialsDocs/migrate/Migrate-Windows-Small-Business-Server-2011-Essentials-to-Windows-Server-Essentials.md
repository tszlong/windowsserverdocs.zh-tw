...
4.  [將 SBS 2011 Essentials 設定和資料移到目的地伺服器](Move-Windows-SBS-2011-Essentials-to-the-Destination-Server-for-migration.md)。  本節提供從來源伺服器移轉資料和設定的相關資訊。  
...
4.  [將 SBS 2011 Essentials 設定和資料移到目的地伺服器](../migrate/Move-Windows-SBS-2011-Essentials-to-the-Destination-Server-for-migration.md)。  本節提供從來源伺服器移轉資料和設定的相關資訊。  
