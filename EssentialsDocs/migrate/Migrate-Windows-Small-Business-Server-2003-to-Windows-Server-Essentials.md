---
title: "將 Windows 小型企業 Server 2003 移轉到 Windows Server Essentials"
...
---
# <a name="migrate-windows-small-business-server-2003-to-windows-server-essentials"></a>將 Windows 小型企業 Server 2003 移轉到 Windows Server Essentials

>適用於：Windows Server 2016 Essentials 程式集 Windows Server 2012 R2、Windows Server 2012 程式集

本指南告訴您如何將現有的 Windows SBS 2003 網域移轉到新的硬體，在 Windows Server® 2012 年基本資訊，然後設定和資料移轉。 本指南以及如何從 Windows Server Essentials 網路移除您現有的伺服器，當您完成移轉。  
  
> [!IMPORTANT]
>   Windows Server Essentials 需要 64 位元的環境。  Windows Server Essentials 不支援 32 位元的環境。  
...
4.  [將 SBS 2003 設定和資料移到目的伺服器](Move-Windows-SBS-2003-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)。  本章節從來源伺服器提供移轉資料和設定的相關資訊。  
...
4.  [將 SBS 2003 設定和資料移到目的伺服器](../migrate/Move-Windows-SBS-2003-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)。  本章節從來源伺服器提供移轉資料和設定的相關資訊。  
