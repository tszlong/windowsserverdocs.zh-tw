...
本指南說明如何將現有的 Windows Small Business Server 2011 Standard 網域遷移至新硬體上的 Windows Server&reg; 2012 Essentials，然後遷移設定和資料。 本指南也說明如何在完成遷移之後，從 Windows Server Essentials 網路移除現有的伺服器。  
