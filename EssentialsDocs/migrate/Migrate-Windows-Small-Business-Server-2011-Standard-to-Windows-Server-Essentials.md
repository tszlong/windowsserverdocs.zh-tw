...
本指南說明如何將現有的 Windows Small Business Server 2011 Standard 網域移轉到 Windows Server® 2012 Essentials，在新硬體上，然後再移轉設定和資料。 本指南也說明如何在完成移轉之後，從 Windows Server Essentials 網路移除現有的伺服器。  
...
3.  [將電腦加入新的 Windows Server Essentials 伺服器](Join-computers-to-the-new-Windows-Server-Essentials-server.md)。  本章節涵蓋用戶端電腦加入新的 Windows Server Essentials 網路，以及更新群組原則設定。  
  
4.  [將 SBS 2011 設定及資料移到目的地伺服器](Move-Windows-SBS-2011-Standard-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)。  本節提供從來源伺服器移轉資料和設定的相關資訊。  
...
3.  [將電腦加入新的 Windows Server Essentials 伺服器](../migrate/Join-computers-to-the-new-Windows-Server-Essentials-server.md)。  本章節涵蓋用戶端電腦加入新的 Windows Server Essentials 網路，以及更新群組原則設定。  
  
4.  [將 SBS 2011 設定及資料移到目的地伺服器](../migrate/Move-Windows-SBS-2011-Standard-settings-and-data-to-the-Destination-Server-for-Windows-Server-Essentials-migration.md)。  本節提供從來源伺服器移轉資料和設定的相關資訊。  
