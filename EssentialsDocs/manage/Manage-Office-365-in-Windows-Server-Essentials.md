...
###  <a name="BKMK_StepOne_VERIFY"></a>步驟1：驗證 Office 365 整合需求  
 在開始之前，請確定伺服器符合這些需求：  
...
###  <a name="BKMK_StepTwo"></a>步驟2：整合伺服器與 Microsoft Office 365  
...
###  <a name="BKMK_StepThree"></a>步驟3：將組織的網際網路功能變數名稱連結到 Office 365 （選擇性）  
