...
|**特徵**|**Windows Server 作業系統版本**|**19.10**|**18.04 LTS**|**16.04 LTS**|**14.04 LTS**|
|-|-|-|-|-|-|
|**可用性**||內建|內建|內建|內建|
...
|索引鍵/值組|2019、2016、2012 R2|&#10004;注6、10|&#10004;注5、10|&#10004;注5、10|&#10004;注5、10|
...
6. 在 Ubuntu 19.10 上，使用最新的虛擬核心來取得最新的 Hyper-v 功能。
   ...
   若要在19.10 上安裝虛擬核心，請以 root （或 sudo）的身分執行下列命令：
