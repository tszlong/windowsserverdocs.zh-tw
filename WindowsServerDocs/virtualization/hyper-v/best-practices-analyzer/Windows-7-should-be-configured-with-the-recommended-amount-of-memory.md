---
title: Windows 7 應該使用建議的記憶體數量來設定
...
ms.locfileid: "59812289"
---
# <a name="windows-7-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows 7 應該使用建議的記憶體數量來設定
...
*執行 Windows 7 的虛擬機器已使用少於 1 gb 的 RAM 建議數量。*  
