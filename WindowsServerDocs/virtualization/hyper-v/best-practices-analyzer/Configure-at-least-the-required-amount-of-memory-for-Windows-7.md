---
title: 設定至少執行 Windows 7 並已啟用動態記憶體的虛擬機器的記憶體數量為需求量
...
ms.locfileid: "59887809"
---
# <a name="configure-at-least-the-required-amount-of-memory-for-a-virtual-machine-running-windows-7-and-enabled-for-dynamic-memory"></a>設定至少執行 Windows 7 並已啟用動態記憶體的虛擬機器的記憶體數量為需求量
...
## <a name="issue"></a>問題  
*一或多個虛擬機器會設定為使用動態記憶體少於所需的 Windows 7 的記憶體數量。*  
