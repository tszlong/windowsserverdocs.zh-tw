---
title: Windows Server 2008 R2 應該設有至少最小記憶體數量
...
ms.locfileid: "59818839"
---
# <a name="windows-server-2008-r2-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Server 2008 R2 應該設有至少最小記憶體數量
...
*執行 Windows Server 2008 R2 的虛擬機器已使用的最小為 512 MB 的 RAM 數量小於。*  
...
### <a name="to-increase-the-memory-using-hyper-v"></a>若要增加使用 HYPER-V 的記憶體  
