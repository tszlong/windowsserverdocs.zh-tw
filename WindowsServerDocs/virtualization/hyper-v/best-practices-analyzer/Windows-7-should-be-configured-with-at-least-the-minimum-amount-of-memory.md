...
ms.locfileid: "59840409"
---
# <a name="windows-7-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows 7 應該設有至少最小記憶體數量
...
*執行 Windows 7 的虛擬機器已使用的最小為 512 MB 的 RAM 數量小於。*  
