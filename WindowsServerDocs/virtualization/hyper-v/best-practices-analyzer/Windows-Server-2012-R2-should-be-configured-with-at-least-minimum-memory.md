---
title: Windows Server 2012 R2 應該設有至少最小記憶體數量
...
ms.locfileid: "59856219"
---
# <a name="windows-server-2012-r2-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Server 2012 R2 應該設有至少最小記憶體數量
...
## <a name="issue"></a>**問題**  
*執行 Windows Server 2012 R2 的虛擬機器已使用的最小為 512 MB 的 RAM 數量小於。*  
