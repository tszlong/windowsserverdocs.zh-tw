---
title: Windows Vista 應該設有至少最小記憶體數量
...
ms.locfileid: "59814999"
---
# <a name="windows-vista-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Vista 應該設有至少最小記憶體數量
...
*執行 Windows Vista 的虛擬機器已使用的最小為 512 MB 的 RAM 數量小於。*  
