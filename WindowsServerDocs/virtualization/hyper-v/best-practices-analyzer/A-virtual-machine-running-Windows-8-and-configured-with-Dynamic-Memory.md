---
title: 執行 Windows 8，並使用動態記憶體設定的虛擬機器應該用於記憶體設定的建議的值
...
ms.locfileid: "59861029"
---
# <a name="a-virtual-machine-running-windows-8-and-configured-with-dynamic-memory-should-use-recommended-values-for-memory-settings"></a>執行 Windows 8，並使用動態記憶體設定的虛擬機器應該用於記憶體設定的建議的值
...
## <a name="issue"></a>**問題**  
*一或多個虛擬機器會設定為使用動態記憶體少於建議適用於 Windows 8 的記憶體數量。*  
