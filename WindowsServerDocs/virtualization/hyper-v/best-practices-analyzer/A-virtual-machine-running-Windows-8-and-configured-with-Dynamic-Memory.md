---
title: 執行 Windows 8 並設定動態記憶體的虛擬機器應該使用建議的記憶體設定值
...
author: kbdazure
ms.date: 8/16/2016
ms.openlocfilehash: 7800535bd686586c32bf0161c889bdd9ea9220c4
ms.sourcegitcommit: dfa48f77b751dbc34409aced628eb2f17c912f08
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/07/2020
ms.locfileid: "87954535"
---
# <a name="a-virtual-machine-running-windows-8-and-configured-with-dynamic-memory-should-use-recommended-values-for-memory-settings"></a>執行 Windows 8 並設定動態記憶體的虛擬機器應該使用建議的記憶體設定值
...
## <a name="issue"></a>**問題**
*一或多部虛擬機器已設定為使用動態記憶體，且小於建議用於 Windows 8 的記憶體數量。*
...
*使用 Hyper-v 管理員將最小記憶體增加到至少 256 MB、啟動記憶體至少為 512 MB，並將記憶體上限設為至少 1 GB （針對此虛擬機器）。*
