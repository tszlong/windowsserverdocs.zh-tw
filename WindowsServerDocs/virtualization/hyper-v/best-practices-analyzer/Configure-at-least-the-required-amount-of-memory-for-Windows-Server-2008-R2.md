---
title: 至少設定必要的虛擬機器執行 Windows Server 2008 R2 且啟用動態記憶體的記憶體數量
...
ms.locfileid: "59860969"
---
# <a name="configure-at-least-the-required-amount-of-memory-for-a-virtual-machine-running-windows-server-2008-r2-and-enabled-for-dynamic-memory"></a>至少設定必要的虛擬機器執行 Windows Server 2008 R2 且啟用動態記憶體的記憶體數量
...
## <a name="issue"></a>問題  
*一或多個虛擬機器會設定為使用動態記憶體少於所需的 Windows Server 2008 R2 的記憶體數量。*  
