---
title: Windows 8 應該使用建議的記憶體數量來設定
...
ms.locfileid: "59849869"
---
# <a name="windows-8-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows 8 應該使用建議的記憶體數量來設定
...
## <a name="issue"></a>**問題**  
*執行 Windows 8 的虛擬機器已使用少於 1 gb 的 RAM 建議數量。*  
