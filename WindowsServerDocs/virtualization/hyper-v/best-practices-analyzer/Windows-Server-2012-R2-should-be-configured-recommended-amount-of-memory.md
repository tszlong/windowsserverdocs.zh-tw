---
title: 應該使用建議的記憶體數量來設定 Windows Server 2012 R2
...
author: kbdazure
ms.date: 8/16/2016
ms.openlocfilehash: 6d066345554636ec981c54c86c641766306ca10c
ms.sourcegitcommit: dfa48f77b751dbc34409aced628eb2f17c912f08
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/07/2020
ms.locfileid: "87948210"
---
# <a name="windows-server-2012-r2-should-be-configured-with-the-recommended-amount-of-memory"></a>應該使用建議的記憶體數量來設定 Windows Server 2012 R2
...
## <a name="issue"></a>**問題**
*執行 Windows Server 2012 R2 的虛擬機器設定了小於建議的 RAM 容量，也就是 2 GB。*
