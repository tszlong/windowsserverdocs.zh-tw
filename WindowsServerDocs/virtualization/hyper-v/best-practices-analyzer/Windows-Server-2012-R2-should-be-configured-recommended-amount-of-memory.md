---
title: 應該使用建議的記憶體數量設定 Windows Server 2012 R2
...
ms.locfileid: "59812149"
---
# <a name="windows-server-2012-r2-should-be-configured-with-the-recommended-amount-of-memory"></a>應該使用建議的記憶體數量設定 Windows Server 2012 R2
...
## <a name="issue"></a>**問題**  
*執行 Windows Server 2012 R2 的虛擬機器已使用少於 2 gb 的 RAM 建議數量。*  
