...
## <a name="BKMK_HyperVManager"></a>使用 HYPER-V 管理員建立虛擬機器  
...
4.  每個頁面上，請您的虛擬機器的適當選擇。 如需詳細資訊，請參閱 <<c0> [ 新的虛擬機器選項和 HYPER-V 管理員中的預設值](#BKMK_Options)本主題稍後的。  
...
## <a name="BKMK_PowerShell"></a>使用 Windows PowerShell 建立虛擬機器  
...
## <a name="BKMK_Options"></a>在 HYPER-V 管理員新增虛擬機器精靈 的選項  
...
- [支援的虛擬機器設定版本](../deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server.md#BKMK_SupportedConfigVersions)  

-   [應該在 HYPER-V 中建立 1 或 2 代虛擬機器嗎？](../plan/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V.md)  

-   [建立 HYPER-V 虛擬機器的虛擬交換器](Create-a-virtual-switch-for-Hyper-V-virtual-machines.md)  
