...
| **特徵**                                                                                                                                  | **Windows server 版本**         | **7.5-7。6**        | **7.4**             | **6.4-6.8 和 7.0-7。3**                                             | **6.4-6.8 和 7.0-7。2**                                             | **OL 與 RHCK 7.0-7。2**         | **OL 與 RHCK 6。8**             | **OL 與 RHCK 6.6，6。7**        | **OL 與 RHCK 6。5**              | **OL 與 RHCK 6。4**               |
|----------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|--------------------|---------------------|---------------------------------------------------------------------|---------------------------------------------------------------------|--------------------------|--------------------------|--------------------------|---------------------------|---------------------------|
...
| VLAN 標記和中繼                                                                                                                    | 2019、2016、2012 R2、2012、2008 R2 | &#10004;           | &#10004;            | &#10004;（適用于 6.4-6.8 的注1）                                       | &#10004;（適用于 6.4-6.8 的注1）                                       | &#10004;                 | &#10004;附注1          | &#10004;附注1          | &#10004;附注1           | &#10004;附注1           |
...
| **特徵**                                                                                                                                  | **Windows server 版本**         | **R5**                | **R4**                | **R3 QU3**            | **R3 QU2**            | **R3 QU1**       |
|----------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|---------------------------|---------------------------|---------------------------|---------------------------|----------------------|
| **可用性**                                                                                                                             |                                    | 內建                  | 內建                  | 內建                  | 內建                  | 內建             |
| **[雙核處理器](Feature-Descriptions-for-Linux-and-FreeBSD-virtual-machines-on-Hyper-V.md#core)**                                                   | 2019、2016、2012 R2、2012、2008 R2 | &#10004;                  | &#10004;                  | &#10004;                  | &#10004;                  | &#10004;             |
| Windows Server 2016 精確時間                                                                                                            | 2019、2016                         |                           |                           |                           |                           |                      |
...
| Hyper-v 特定的影片裝置                                                                                                                | 2019、2016、2012 R2、2012、2008 R2 | &#10004;                  | &#10004;                  | &#10004;                  | &#10004;                  |                      |
| **[其他](Feature-Descriptions-for-Linux-and-FreeBSD-virtual-machines-on-Hyper-V.md#miscellaneous)**                                 |                                    |                           |                           |                           |                           |                      |
| 索引鍵/值組                                                                                                                               | 2019、2016、2012 R2、2012、2008 R2 | &#10004;注11，12      | &#10004;注11，12      | &#10004;注11，12      | &#10004;注11，12      | &#10004;注11，12 |
| 非遮罩式插斷                                                                                                                       | 2019、2016、2012 R2                | &#10004;                  | &#10004;                  | &#10004;                  | &#10004;                  | &#10004;             |
...
2. 使用虛擬光纖通道裝置時，請確定已填入邏輯單元編號0（LUN 0）。 如果尚未填入 LUN 0，Linux 虛擬機器可能無法以原生方式掛接光纖通道裝置。
