...
> [!NOTE]
> 如需有關 System Center 虛擬機器管理員 (VMM) 的資訊，請參閱 [Virtual Machine Manager](/system-center/vmm/overview)。 VMM 是 Microsoft 的產品，用來管理虛擬化的資料中心，此產品單獨銷售。
