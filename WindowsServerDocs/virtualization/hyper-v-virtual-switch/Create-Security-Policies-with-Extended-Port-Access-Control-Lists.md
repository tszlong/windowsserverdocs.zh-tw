...
### <a name="enforce-application-level-security"></a><a name="bkmk_enforce"></a>強制執行應用層級安全性  
...
### <a name="enforce-both-user-level-and-application-level-security"></a><a name="bkmk_both"></a>同時強制執行使用者層級和應用層級安全性  
...
### <a name="provide-security-support-to-a-non-tcpudp-application"></a><a name="bkmk_tcp"></a>提供非 TCP/UDP 應用程式的安全性支援  
...
## <a name="stateful-acl-rules"></a><a name="bkmk_stateful"></a>具狀態 ACL 規則  
