...
Windows Server 虛擬化技術包含 HYPER-V、 HYPER-V 虛擬交換器，以及受防護網狀架構與受防護虛擬機器 \(VMs\)，更新，可改善安全性、 延展性及可靠性。 容錯移轉叢集、網路功能和儲存空間的更新讓您更容易在搭配 Hyper-V 時部署和管理這些技術。 
