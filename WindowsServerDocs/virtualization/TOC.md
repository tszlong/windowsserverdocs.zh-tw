...
### [Hyper-V 的新功能](hyper-v/What-s-new-in-Hyper-V-on-Windows.md)
...
#### [使用 DDA 部署儲存裝置](hyper-v/deploy/deploying-storage-devices-using-dda.md)
...
#### [部署 Hyper-V 複本](hyper-v/manage/Set-up-Hyper-V-Replica.md) 
#### [移動具有即時移轉的 VM](hyper-v/manage/Live-migration-overview.md) 
##### [即時移轉概觀](hyper-v/manage/Live-migration-overview.md) 
##### [設定可進行即時移轉的主機](hyper-v/deploy/Set-up-hosts-for-live-migration-without-Failover-Clustering.md) 
##### [不用容錯移轉叢集，而使用即時移轉](hyper-v/manage/Use-live-migration-without-Failover-Clustering-to-move-a-virtual-machine.md) 
