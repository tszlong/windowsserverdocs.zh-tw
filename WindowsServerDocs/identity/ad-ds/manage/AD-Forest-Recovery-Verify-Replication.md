...
1. 當第一個還原的 DC 上出現 DFSR 事件4612時，請執行手動授權還原，如 [2218556 中所述：如何針對 DFSR 複寫的 SYSVOL （例如 FRS 的 "D4/D2"）強制執行權威和非權威同步處理 ](https://support.microsoft.com/kb/2218556) （ https://support.microsoft.com/kb/2218556) 。  
