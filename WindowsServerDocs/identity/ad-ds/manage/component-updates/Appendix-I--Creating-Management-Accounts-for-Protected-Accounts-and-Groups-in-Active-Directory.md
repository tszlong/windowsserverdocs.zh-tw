...
無論您選擇如何建立群組來放置管理帳戶，您都應該確定每個帳戶的安全，如稍早所述。 您也應該考慮依照 [附錄 D：在 Active Directory 中保護內建的系統管理員帳戶](../../../ad-ds/plan/security-best-practices/Appendix-D--Securing-Built-In-Administrator-Accounts-in-Active-Directory.md)，來實行如下所述的 GPO 限制。
