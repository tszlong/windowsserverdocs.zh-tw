...
|------------|------------------------|------------------|-----------------|---------------------|--------------------|  
|[案例1：加入現有的樹系以進行資料自主性](#BKMK_1)|不可以|不可以|是|不可以|不可以|  
|[案例2：使用組織樹系或網域來進行服務自主性](#BKMK_2)|不可以|不可以|不適用|不可以|是|  
|[案例3：使用組織樹系或資源樹系進行服務隔離](#BKMK_3)|不可以|不可以|不適用|是|不適用|  
|[案例4：使用組織樹系或限制存取樹系來進行資料隔離](#BKMK_4)|不適用|是|不適用|不適用|不適用|  
|[案例5：使用組織樹系，或將防火牆重新設定為有限的連線能力](#BKMK_5)|是|不可以|不適用|不可以|不可以|  
|[案例6：使用組織樹系或網域，並針對具有有限連線能力的服務自主性重新設定防火牆](#BKMK_6)|是|不可以|不適用|不可以|是|  
|[案例7：使用資源樹系，並以有限的連線能力重新設定防火牆以進行服務隔離](#BKMK_7)|是|不可以|不適用|是|不適用|  

## <a name="BKMK_1"></a>案例1：加入現有的樹系以進行資料自主性  
...
## <a name="BKMK_2"></a>案例2：使用組織樹系或網域來進行服務自主性  
...
## <a name="BKMK_3"></a>案例3：使用組織樹系或資源樹系進行服務隔離  
...
## <a name="BKMK_5"></a>案例5：使用組織樹系，或將防火牆重新設定為有限的連線能力  
...
## <a name="BKMK_7"></a>案例7：使用資源樹系，並以有限的連線能力重新設定防火牆以進行服務隔離  
