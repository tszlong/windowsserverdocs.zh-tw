...
|遠端桌面服務使用者|內建的容器<br /><br />網域本機安全性群組|從遠端使用 RDP 登入的權限會授與此群組的成員。<br /><br />**直接的使用者權限：** None<br /><br />**繼承的使用者權限：**<br /><br />從網路存取這台電腦<br /><br />將工作站新增至網域<br /><br />略過周遊檢查<br /><br />增加處理程序工作組|  
|遠端管理伺服器 (Windows Server 2012)|內建的容器<br /><br />網域本機安全性群組|此群組的成員可以存取 WMI 資源，透過管理通訊協定 （例如透過 Windows 遠端管理服務的 WS 管理）。 只適用於存取權授與使用者的 WMI 命名空間。<br /><br />**直接的使用者權限：** None<br /><br />**繼承的使用者權限：**<br /><br />從網路存取這台電腦<br /><br />將工作站新增至網域<br /><br />略過周遊檢查<br /><br />增加處理程序工作組|  
