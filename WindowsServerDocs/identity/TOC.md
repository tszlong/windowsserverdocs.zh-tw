...
###### [Azure 虛擬機器上執行 Active Directory](ad-ds/deploy/virtual-dc/adds-on-azure-vm.md)
...
##### [在 WindowsServer 2003 組織中部署 AD DS](ad-ds/plan/Deploying-AD-DS-in-a-Windows-Server-2003-Organization.md)
##### [在 WindowsServer 2000 組織中部署 AD DS](ad-ds/plan/Deploying-AD-DS-in-a-Windows-2000-Organization.md)
...
##### [尋找其他 WindowsServer 2008 Active Directory 站台拓撲設計資源](ad-ds/plan/finding-additional-Resources-for-Windows-Server-2008-active-directory-Site-Topology-Design.md)
...
#### [將網域控制站升級為 WindowsServer 2012 R2 與 WindowsServer 2012](ad-ds/deploy/Upgrade-Domain-Controllers-to-Windows-Server-2012-R2-and-Windows-Server-2012.md)
...
###### [CA 備份與還原 Windows PowerShell Cmdlett](ad-ds/manage/component-updates/CA-Backup-and-Restore-Windows-powershell-cmdlets.md)
...
#### [疑難排解 Active Directory 複寫問題](ad-ds/manage/troubleshoot/Troubleshooting-active-directory-Replication-Problems.md)
...
##### [WindowsServer 2012 R2 中的 AD FS 設計指南](ad-fs/design/AD-FS-Design-Guide-in-Windows-Server-2012-R2.md)
...
###### [ADFS 需求](ad-fs/design/AD-FS-Requirements.md)
##### [WindowsServer 2012 中的 AD FS 設計指南](ad-fs/design/AD-FS-Design-Guide-in-Windows-Server-2012.md)
...
#### [在 WindowsServer 2012 R2 設定 AD FS 實驗室環境](ad-fs/deployment/Set-up-the-lab-environment-for-AD-FS-in-Windows-Server-2012-R2.md)
...
#### [WindowsServer 2016 和 2012 R2 AD FS 部署指南](ad-fs/deployment/Windows-Server-2012-R2-AD-FS-Deployment-Guide.md)
...
#### [WindowsServer 2012 AD FS 部署指南](ad-fs/deployment/Windows-Server-2012-AD-FS-Deployment-Guide.md)
...
#### [WindowsServer 2016 中的 AD FS 代表驗證](ad-fs/development/AD-FS-On-behalf-of-Authentication-in-Windows-Server.md)
...
#### [委派 AD FS Powershell Commandlet 存取權給非系統管理員的使用者](ad-fs/operations/delegate-ad-fs-pshell-access.md)
...
#### [逐步解說：將 Windows 裝置加入 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-with-a-Windows-Device.md)
#### [逐步解說：將 iOS 裝置加入 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-with-an-iOS-Device.md)
#### [逐步解說：將 Android 裝置加入 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-to-an-Android-device.md)
