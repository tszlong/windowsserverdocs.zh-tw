...
| ida: 授權單位            | 這是您 AD FS 服務的 URL, 例如 https://fs.anandmsft.com/adfs/                                                                                                                                          |
...
在第二次與權杖端點互動時, 您可以看到我們將**requested_token_use**設定為**on_behalf_of** , 並使用為仲介層 web 服務取得的存取權杖 https://localhost:44321/ , 也就是判斷提示以取得代理者 token。
