...
1.  首先，讓全域原則中的提供者：
    ...
    > [!NOTE]
    > 請注意 AdditionalAuthenticationProvider 參數提供的值，對應您提供給上方 Register-adfsauthenticationprovider cmdlet 中的 「 名稱 」 參數的值，並從 「 名稱 」 屬性取得 Register-adfsauthenticationprovider cmdlet 的輸出。 
    > <P></P>

    
    範例：`PS C:\>Set-AdfsGlobalAuthenticationPolicy –AdditionalAuthenticationProvider “MyMFAAdapter”`
