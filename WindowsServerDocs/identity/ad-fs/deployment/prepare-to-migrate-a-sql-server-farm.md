...
> [!NOTE]
>  在下列檔案中，記錄 "policystore connectionstring =" 後面的 SQL Server 連接字串： `%programfiles%\Active Directory Federation Services 2.0\Microsoft.IdentityServer.Servicehost.exe.config`。 當您還原同盟伺服器上的原始 AD FS 設定時，需要此字串。  
