...
|![設定 AD FS 來傳送宣告](media/icon_checkboxo.gif)|如果您尚未這樣做，使用右側的連結，先建立一個信賴憑證者信任與 Windows Server 2012 中 AD FS Federation Service AD FS 1。*x* Federation Service。|[檢查清單：將 AD FS 設定為將宣告傳送至 AD FS 1.x 同盟服務](Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Federation-Service.md)|  
