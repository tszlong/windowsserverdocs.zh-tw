...
ms.locfileid: "71359322"
---
#  <a name="prepare-to-migrate-a-stand-alone-ad-fs-federation-server-or-a-single-node-ad-fs-farm"></a>準備遷移獨立的 AD FS 同盟伺服器或單一節點 AD FS 伺服器陣列  
 
若要準備將獨立 AD FS 2.0 同盟伺服器或單一節點 AD FS 伺服器陣列遷移至 Windows Server 2012，您必須從這部伺服器匯出並備份 AD FS 設定資料。  
