...
### <a name="to-install-the-ad-fs-server-role-via-the-add-roles-and-features-wizard"></a>透過 [新增角色及功能] wizard 安裝 AD FS 伺服器角色  
  
1.  開啟伺服器管理員。 若要開啟伺服器管理員，請按一下 [**開始**] 畫面上的 [**伺服器管理員**]，或桌面上工作列中的 [**伺服器管理員**]。 在 [儀表板] 頁面上 [歡迎使用] 磚的 [快速入門] 索引標籤中，按一下 [新增角色及功能]。 或者，您可以按一下 [管理] 功能表中的 [新增角色及功能]。  
