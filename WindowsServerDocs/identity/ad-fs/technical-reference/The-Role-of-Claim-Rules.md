...
|委派授權規則集|您在信賴憑證者信任上使用的一組宣告規則，用以指定將允許作為對信賴憑證者的其他使用者的委派。<p>這些規則會決定是否允許要求者模擬使用者，同時識別在傳送到信賴憑證者的權杖中的要求者。<p>除非您指定委派授權規則，否則不會有任何使用者預設作為委派。|信賴憑證者信任|
