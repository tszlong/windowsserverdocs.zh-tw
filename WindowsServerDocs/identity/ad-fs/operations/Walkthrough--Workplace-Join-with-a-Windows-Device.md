...
[在 Windows Server 2012 R2](../deployment/Set-up-the-lab-environment-for-AD-FS-in-Windows-Server-2012-R2.md) 
 中設定 AD FS 的實驗室環境[逐步解說：使用 IOS 裝置 Workplace Join](Walkthrough--Workplace-Join-with-an-iOS-Device.md)
