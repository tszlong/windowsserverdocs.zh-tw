...
您知道 Microsoft Azure 在雲端中提供類似的功能嗎？ 深入了解 [Microsoft Azure 身分識別解決方案](http://aka.ms/m2w274)。<br /><br />在 Microsoft Azure 中建立混合式身分識別解決方案：<br /> - [瞭解 Azure 多重要素驗證。](http://aka.ms/ey6o9r)<br /> - [使用雲端驗證管理單一樹系混合式環境的身分識別。](http://aka.ms/g1jat8)<br /> - [透過其他多因素驗證管理機密應用程式的風險。](http://aka.ms/kt1bbm)
