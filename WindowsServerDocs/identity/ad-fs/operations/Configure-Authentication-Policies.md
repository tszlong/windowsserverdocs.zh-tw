...
4.  在 [**編輯全域驗證原則**] 視窗的 [**主要**] 索引標籤上，您可以將下列設定設為全域驗證原則的一部分：
    ...
    -   透過 [**啟用裝置驗證**] 核取方塊進行裝置驗證。 如需詳細資訊，請參閱 [Join to Workplace from Any Device for SSO and Seamless Second Factor Authentication Across Company Applications](../../ad-fs/operations/Join-to-Workplace-from-Any-Device-for-SSO-and-Seamless-Second-Factor-Authentication-Across-Company-Applications.md)。
