...
這些很罕見發生
1)  如果您的 CRL 清單很長，可能會在嘗試下載時遇到一段時間。 在此情況下，您必須依據 https://support.microsoft.com/help/820129/http-sys-registry-settings-for-windows 更新 ' MaxFieldLength ' 和 ' MaxRequestByte '
