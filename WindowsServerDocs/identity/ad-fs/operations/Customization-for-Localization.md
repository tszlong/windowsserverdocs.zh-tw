...
在自訂內容之後，自訂會有較高的優先順序；因此，您應該自訂您想要支援的所有語言。 所有的自訂內容皆接受地區設定參數。 當您設定當地語系化的內容時，在您設定國家/地區 @ no__t-0less 地區設定（例如 "en"）之前，請先將其設定為使用國家/地區 @ no__t-1specific 地區設定，例如 "en @ no__t-2us"。  
