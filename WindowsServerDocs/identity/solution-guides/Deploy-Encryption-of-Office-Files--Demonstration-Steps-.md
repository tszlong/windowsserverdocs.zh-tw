...
## <a name="step-1-enable-resource-properties"></a><a name="BKMK_1.1"></a>步驟1：啟用資源屬性  
...
## <a name="step-2-create-classification-rules"></a><a name="BKMK_2"></a>步驟2：建立分類規則  
...
## <a name="step-3-use-file-management-tasks-to-automatically-protect-documents-with-ad-rms"></a><a name="BKMK_3"></a>步驟3：使用檔案管理工作自動使用 AD RMS 保護檔  
...
## <a name="step-4-view-the-results"></a><a name="BKMK_4"></a>步驟4：查看結果  
...
## <a name="step-5-verify-protection-with-ad-rms"></a><a name="BKMK_5"></a>步驟5：使用 AD RMS 驗證保護  
