...
19. 在 [**服務帳戶**] 畫面的 [**網域使用者帳戶**] 中，按一下 [**指定**]，然後指定使用者名稱 (**Contoso\rms**) ] 和 [密碼 (<strong>pass@word1</strong> ]) 然後按一下 **[確定]**，再按 **[下一步**]。
...
28. 在 [結果]**** 畫面上，按一下 [關閉]****，然後按一下 [安裝進度]**** 畫面上的 [關閉]****。 完成時，請使用 () 所提供的密碼來登出，並以 contoso\rms 的身分登入 <strong>pass@word1</strong> 。
