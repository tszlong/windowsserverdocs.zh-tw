...
## <a name="step-3-create-a-file-management-task"></a><a name="BKMK_Step3"></a>步驟 3：建立檔案管理工作
...
## <a name="step-4-classify-a-file-manually"></a><a name="BKMK_Step4"></a>步驟 4：手動分類檔案
