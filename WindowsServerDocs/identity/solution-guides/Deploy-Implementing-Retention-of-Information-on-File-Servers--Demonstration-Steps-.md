...
![解決方案指南](media/Deploy-Implementing-Retention-of-Information-on-File-Servers--Demonstration-Steps-/PowerShellLogoSmall.gif)***<em>Windows PowerShell 對等的命令</em>***  
...
5.  在 [電子郵件通知]  索引標籤中，設定下列選項：  
    ...
    -   在 **預設的 「 來源 」 電子郵件地址**方塊中，輸入應該用來傳送通知電子郵件地址。  
...
-   [規劃檔案伺服器上的資料保留](assetId:///edf13190-7077-455a-ac01-f534064a9e0c)  
