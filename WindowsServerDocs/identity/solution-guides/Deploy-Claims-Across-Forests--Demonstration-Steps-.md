...
1.  登入網域控制站，以系統管理員身分使用密碼的 adatum.com **pass@word1**。  
...
1.  登入網域控制站，以系統管理員身分使用密碼的 contoso.com **pass@word1**。  
...
1.  登入用戶端電腦，Jeff Low，密碼為 CLIENT1 **pass@word1**。  
