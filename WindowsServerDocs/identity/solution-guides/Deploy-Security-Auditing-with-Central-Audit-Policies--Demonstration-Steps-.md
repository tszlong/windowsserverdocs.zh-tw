...
ms.locfileid: "87956075"
---
# <a name="deploy-security-auditing-with-central-audit-policies-demonstration-steps"></a>使用集中稽核原則部署安全性稽核 (示範步驟)

>適用於：Windows Server 2016、Windows Server 2012 R2、Windows Server 2012

在此案例中，您將使用您在部署集中存取原則中所建立的財務原則來審核 [財務檔] 資料夾中的檔案存取權[&#40;示範步驟&#41;](Deploy-a-Central-Access-Policy--Demonstration-Steps-.md)。 如果未獲得授權存取資料夾的使用者嘗試存取該資料夾，就會在事件檢視器中擷取該活動。
以下為測試這個案例的必要步驟。
...
1. 使用密碼登入網域控制站 DC1 做為 contoso\administrator <strong>pass@word1</strong> 。
...
1. 以密碼登入檔案伺服器，FILE1 為 contoso\Administrator <strong>pass@word1</strong> 。
