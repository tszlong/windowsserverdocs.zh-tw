...
|[在自訂埠上為憑證金鑰型更新設定憑證註冊 Web 服務](certificate-enrollment-certificate-key-based-renewal.md)|本文提供逐步指示，說明如何在443以外的自訂埠上，將憑證註冊 Web 服務 (或憑證註冊原則 (CEP) /憑證註冊服務 (CES) # A5 用於以憑證金鑰為基礎的更新，以利用 CEP 和 CES 的自動續約功能。 |
