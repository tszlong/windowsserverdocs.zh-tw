...
|內容類型|參考|  
|----------------|--------------|  
|**產品評估**|-   [動態存取控制審核者指南](https://go.microsoft.com/fwlink/?LinkId=244309)<br />-   [動態存取控制開發人員指導方針](https://go.microsoft.com/fwlink/?LinkId=245870)|  
|**規劃**|-   [規劃集中存取原則部署](assetId:///0311a76d-d66c-4ddb-ade6-af586a2ad82f)<br />-   [規劃檔案存取審核](Plan-for-File-Access-Auditing.md)|  
...
|**作業**|[動態存取控制 PowerShell 參考](https://go.microsoft.com/fwlink/?LinkId=243150)|  
