...
## <a name="release-notes-important-issues-in-windows-server"></a>[版本資訊：Windows Server 中的重要問題](Windows-Server-2016-GA-Release-Notes.md)
未避免或解決時可能會造成嚴重問題的問題。

## <a name="recommendations-for-moving-to-windows-server-2016"></a>[移至 Windows Server 2016 的建議](Recommendations-moving-to-Server2016.md)
在各種情況下使用 Windows Server 2016 的可用方法完整表格。

## <a name="features-removed-or-deprecated-in--windows-server-2016"></a>[Windows Server 2016 中已移除或取代的功能](deprecated-features.md)
