...
## <a name="release-notes-important-issues-in-windows-serverwindows-server-2016-ga-release-notesmd"></a>[版本資訊：Windows Server 中的重要問題](Windows-Server-2016-GA-Release-Notes.md)
未避免或解決時可能會造成嚴重問題的問題。
...
## <a name="features-removed-or-deprecated-in--windows-server-2016deprecated-featuresmd"></a>[Windows Server 2016 中已移除或取代的功能](deprecated-features.md)
...
## <a name="server-application-compatibility-tableserver-application-compatibilitymd"></a>[伺服器應用程式相容性表格](Server-Application-Compatibility.md)
SQL 是否作用於 Windows Server 2016？ 執行 Exchange 所需的步驟為何？ 本主題說明您必須執行的作業。

## <a name="server-activation-guideserver-2016-activationmd"></a>[伺服器啟用指南](Server-2016-activation.md)
