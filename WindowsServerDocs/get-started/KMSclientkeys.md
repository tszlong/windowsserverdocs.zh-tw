...
>[!NOTE]
> 請依照表，「 LTSC 」 代表 「 長期維護通道，」 而 「 LTSB 」 是指 「 長期維護分支。 」 

**若要使用此處所列的識別碼 (它們是 GVLK)，您的部署中必須先有 KMS 主機在執行。** 如果您尚未設定 KMS 主機，請參閱[部署 KMS 啟用](https://technet.microsoft.com/library/dn502531(v=ws.11).aspx)的步驟來安裝一部 KMS 主機。

如果您將電腦從 KMS 主機、MAK 或 Windows 零售版轉換成 KMS 用戶端，請從下表安裝適用的安裝識別碼 (GVLK)。 若要安裝用戶端安裝識別碼，請在用戶端開啟系統管理命令提示字元，輸入 **slmgr /ipk \<setup key\>**，然後按 **Enter**。

| 如果您想要...                                                                                                                                                                                          | ...使用這些資源                                                                                                         |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| 在大量啟用情況之外啟用 Windows (也就您嘗試啟用零售版的 Windows)，**這些識別碼將無法運作**。                                                     | 在零售版的 Windows 中使用下列連結：                                                                              |
| 修正在您嘗試啟用 Windows 8.1 或 Windows Server 2012 R2 或更新系統時發生的錯誤︰「錯誤：0xC004F050 軟體授權服務報告指出產品金鑰無效」… | 如果 KMS 主機執行 Windows 8.1、Windows Server 2012 R2、Windows 8 或 Windows Server 2012，請在 KMS 主機上[安裝此更新](https://support.microsoft.com/en-us/help/3172614/july-2016-update-rollup-for-windows-8-1-and-windows-server-2012-r2) 。 |
...
## Windows 10 中，所有支援的半年通道版本

請參閱[Windows 生命週期事實工作表](https://support.microsoft.com/en-us/help/13853/windows-lifecycle-fact-sheet)中支援的版本和結束日期服務的相關資訊。

| 作業系統版本          | KMS 用戶端安裝識別碼          |
|-----------------------------------|-------------------------------|
|Windows 10 專業版|W269N-WFGWX-YVC9B-4J6C9-T83GX|
|Windows 10 專業版 N|MH37W-N47XK-V7XM9-C7227-GCQG9|
|Windows 10 專業版工作站|NRG8B-VKK3Q-CXVCJ-9G2XF-6Q84J|
|Windows 10 專業版工作站 N|9FNHH-K3HBT-3W4TD-6383H-6XYWF|
...
|Windows 10 企業版 N    |DPH2V-TTNVB-4X9Q3-TJR4H-KHJW4|
...
| 作業系統版本          | KMS 用戶端安裝識別碼          |
|-----------------------------------|-------------------------------|
| Windows 10 企業版 2015 長期維護   | WNMTR-4C88C-JK8YV-HQ7T2-76DF9 |
| Windows 10 企業版 2015 長期維護 N | 2F77B-TNFGY-69QQF-B8YKP-D69TJ |
...
| Windows7 企業版                             | 33PXH-7Y6KF-2VJC9-XBBR8-HVTHH |
