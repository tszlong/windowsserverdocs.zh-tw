...
- 設定 Windows 防火牆設定。   
   ...
   3. 啟用設定檔的遠端桌面 (TCP-IN)：**網域**、**私人**及**公用** (如上所示)。
...
6.  為您的 VHD 建立[磁碟](https://docs.microsoft.com/azure/virtual-machines/windows/prepare-for-upload-vhd-image)。   
     ...
     d. 選取 Windows 作業系統類型和 \[大小\] (預設為 1023)。   
     e. 按一下 \[建立\]****。   
