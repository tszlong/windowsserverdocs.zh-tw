...
>[!NOTE]
>沒有選項可建立已中斷連結 Active Directory 的叢集，其中在 AD DS 中建立任何 CNO 或 Vco。 這是以特定的叢集部署類型為目標。 如需詳細資訊，請參閱[部署已中斷連結 Active Directory 的叢集](<https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/dn265970(v%3dws.11)>)。
...
- 選項 2：[預先設置叢集角色的 VCO](#prestage-a-vco-for-a-clustered-role)。 如果因為組織的需求而必須預先設定叢集角色的帳戶，請使用此選項。 例如，您可能需要控制命名慣例，或控制要建立哪些叢集角色。
