...
|  [叢集和集區仲裁](../storage/storage-spaces/understand-quorum.md)   |  [搭配儲存空間直接存取使用客體虛擬機器叢集](../storage/storage-spaces/storage-spaces-direct-in-vm.md)       | [預先設置叢集電腦物件，Active Directory 網域服務中](prestage-cluster-adds.md) |
