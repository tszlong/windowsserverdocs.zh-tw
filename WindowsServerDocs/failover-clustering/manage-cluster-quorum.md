...
您可以使用[get-clusternode](/powershell/module/failoverclusters/get-clusternode?view=win10-ps) Windows PowerShell Cmdlet，透過叢集節點的**DynamicWeight**一般屬性來驗證節點的叢集指派動態投票。 值 0 表示節點沒有仲裁投票。 值 1 表示節點具有仲裁投票。
