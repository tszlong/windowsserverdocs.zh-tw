...
ms.locfileid: "4339586"
---
# 準備您的 Windows Admin Center 環境
...
## 準備 Windows Server 2012 和 2012 R2
...
確保[.NET Framework 4.5.2 或更新版本](https://docs.microsoft.com/dotnet/framework/install/on-windows-7)已安裝在您的電腦上。
...
## 準備 Microsoft Hyper-V Server 2016

若要使用 Windows Admin Center 管理 Microsoft Hyper-V Server 2016，有一些伺服器角色必須先啟用，您才可以開始使用。

### 若要使用 Windows Admin Center 管理 Microsoft Hyper-V Server 2016：
...
### **步驟 3：** 啟用 PowerShell 的 Hyper-V 模組
...
### **步驟 1：** 安裝 Windows Management Framework 5.1
...
### 步驟 4：啟用 PowerShell 的 Hyper-V 模組 ##
