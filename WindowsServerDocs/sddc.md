...
![學習圖示](media/sddc/learn.png)**[深入了解 Windows Server 超融合](https://docs.microsoft.com/windows-server/get-started/what-s-new-in-windows-server-2016#computevirtualizationvirtualizationmd)**
...
![學習圖示](media/sddc/learn.png)**[深入了解客體叢集與共用 VHDX](https://technet.microsoft.com/library/dn281956(v=ws.11).aspx)**
...
![學習圖示](media/sddc/learn.png)**[深入了解 Hyper-V 複本](https://docs.microsoft.com/windows-server/virtualization/hyper-v/manage/set-up-hyper-v-replica)**
...
![學習圖示](media/sddc/learn.png)**[深入了解網路控制卡](https://docs.microsoft.com/windows-server/networking/sdn/technologies/network-controller/network-controller)**
...
![學習圖示](media/sddc/learn.png)**[深入了解資料中心防火牆](https://docs.microsoft.com/windows-server/networking/sdn/technologies/network-function-virtualization/datacenter-firewall-overview)**

### <a name="switch-embedded-teaming"></a>交換器內嵌小組

![用於間距用途的線條影像](media/sddc/networking-line.png)

SET 是替代的 NIC 小組解決方案，您可將其用於包含 Hyper-V 及[軟體定義的網路功能 (SDN)](https://docs.microsoft.com/windows-server/networking/sdn/software-defined-networking) 堆疊的環境中。

![僅供間距用途的影像](media/sddc/spacer1.png)![交換器內嵌小組圖表](media/sddc/teaming.png)

![學習圖示](media/sddc/learn.png)**[深入了解交換器內嵌小組](https://docs.microsoft.com/windows-server/networking/sdn/technologies/set-for-sdn)**
...
![學習圖示](media/sddc/learn.png)**[深入了解軟體負載平衡](https://docs.microsoft.com/windows-server/networking/sdn/technologies/network-function-virtualization/software-load-balancing-for-sdn)**
...
![學習圖示](media/sddc/learn.png)**[深入了儲存體 QoS](https://docs.microsoft.com/windows-server/storage/storage-qos/storage-qos-overview)**
...
![學習圖示](media/sddc/learn.png)**[深入了解儲存體複本](https://docs.microsoft.com/windows-server/storage/storage-replica/storage-replica-overview)**
...
![學習圖示](media/sddc/learn.png)**[深入了解受防護網狀架構](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-and-shielded-vms)**
...
![學習圖示](media/sddc/learn.png)**[深入了解受防護的 VM](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-and-shielded-vms)**
...
![學習圖示](media/sddc/learn.png)**[深入了解主機守護者服務](https://docs.microsoft.com/windows-server/virtualization/guarded-fabric-shielded-vm/guarded-fabric-manage-hgs)**
...
![學習圖示](media/sddc/learn.png)**[深入了解裝置健康情況證明](https://docs.microsoft.com/windows-server/security/device-health-attestation)**
...
![學習圖示](media/sddc/learn.png)**[深入了解 PowerShell DSC](https://docs.microsoft.com/powershell/dsc/overview)**
...
![學習圖示](media/sddc/learn.png)**[深入了解 System Center VMM](https://docs.microsoft.com/system-center/vmm/)**
