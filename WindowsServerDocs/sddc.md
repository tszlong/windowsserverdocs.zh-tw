...
![](media/sddc/video.png) **[觀看影片進一步了解 Microsoft 的 SDDC](https://mva.microsoft.com/training-courses/whats-new-in-windows-server-2016-16457?l=YcsJR6sXC_1006218965)**

![](media/sddc/poster-ico.png) **[下載此頁面的海報大小 .pdf 檔案](https://github.com/MicrosoftDocs/windowsserverdocs/blob/master/WindowsServerDocs/media/sddc/sddc_poster_0801417_ANSI-E.pdf)**
...
![](media/sddc/learn.png) **[深入了解 WSSD 解決方案](https://www.microsoft.com/cloud-platform/software-defined-datacenter)**
...
![](media/sddc/learn.png) **[深入了解 Hyper-V Hypervisor](https://www.microsoft.com/cloud-platform/server-virtualization)**
...
![每個節點都有本機連結的磁碟機，由「儲存空間直接存取」加入叢集層級的集區，然後由 VM 透過 CSV 來存取](media/sddc/spacer1.png)![](media/sddc/ssd.png)
...
![](media/sddc/learn.png) **[深入了儲存體 QoS](https://docs.microsoft.com/windows-server/storage/storage-qos/storage-qos-overview)**
