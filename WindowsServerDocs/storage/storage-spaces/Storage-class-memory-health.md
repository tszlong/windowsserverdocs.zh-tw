...
ms.locfileid: "5014061"
---
# Windows 中的存放裝置類別記憶體 (NVDIMM-N) 健全狀況管理
> 適用於︰Windows Server 2016、Windows 10 (版本 1607)
...
- [加速 SQL Server 2016 使用 Windows Server 2016 中的持續性記憶體的效能](https://channel9.msdn.com/Shows/Data-Exposed/SQL-Server-2016-and-Windows-Server-2016-SCM--FAST)
...
|802c-01-1602-117cb64f|Warning|預測性失敗|{超出閾值，NVDIMM\_N 錯誤}|
...
## NVDIMM-N 會顯示容量為 '0' 位元組或是「一般實體磁碟」
...
## 在重新開機後，NVDIMM-N 會顯示為 RAW 或空的磁碟
