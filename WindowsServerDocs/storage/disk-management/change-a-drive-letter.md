...
1. 在 磁碟管理，以滑鼠右鍵按一下您要變更或新增磁碟機代號，然後選取磁碟的機**變更磁碟機代號及路徑**。<br>
...
1. 若要變更的磁碟機代號，請選取**變更**。 若要新增的磁碟機代號，如果磁碟機還沒有，選取**新增**。<br>![[變更磁碟機代號及路徑] 對話方塊](media/change-drive-letter2.png)
3. 選取新的磁碟機代號，請選取 **[確定]**，然後選取**是**當系統提示您關於如何依賴的磁碟機代號的程式可能無法正確執行。<br>![顯示 [變更磁碟機代號的 [變更磁碟機代號或路徑] 對話方塊](media/change-drive-letter3.png)