# [儲存空間](storage.md)
## [儲存體的新功能](whats-new-in-storage.md)
## [重複資料刪除](data-deduplication/overview.md)
### [重複資料刪除的新功能](data-deduplication/whats-new.md)
...
### [DFS 複寫：常見問題 (FAQ)](dfs-replication/dfsr-faq.md)
...
### [管理遠端儲存資源](fsrm/managing-remote-storage-resources.md)
...
### [疑難排解使用者設定檔](folder-redirection/troubleshoot-user-profiles-events.md)
## iSCSI
...
### [常見問題 (FAQ)](storage-migration-service/faq.md)
...
#### [容錯和儲存效率](storage-spaces/Storage-Spaces-Fault-Tolerance.md)
...
#### [災害復原](storage-spaces/storage-spaces-direct-disaster-recovery.md)
### 部署
...
#### [分隔磁碟區配置](storage-spaces/delimit-volume-allocation.md)
#### [透過 Azure 監視器進行監視](storage-spaces/configure-azure-monitor.md)
### 疑難排解
...
#### [步驟 1 設定複寫](work-folders/deploy-work-folders-adfs-step1.md)
...
## [儲存類別記憶體健康情況管理](storage-spaces/Storage-class-memory-health.md)
