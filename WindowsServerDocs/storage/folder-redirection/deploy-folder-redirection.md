...
> [!IMPORTANT]
> 由於 [MS16-072](https://support.microsoft.com/help/3163622/ms16-072-security-update-for-group-policy-june-14-2016) 中所做的安全性變更，現在您必須授與已驗證的使用者群組對資料夾重新導向 GPO 的「讀取」權限，否則 GPO 將不會套用至使用者；或就算已套用，系統也會移除 GPO，並將資料夾重新導向至本機電腦。 如需詳細資訊，請參閱[部署群組原則安全性更新 MS16-072](https://blogs.technet.microsoft.com/askds/2016/06/22/deploying-group-policy-security-update-ms16-072-kb3163622/)。
