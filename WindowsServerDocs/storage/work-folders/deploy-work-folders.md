...
|**部署**|-   [使用 AD FS 和 Web 應用程式 Proxy 部署工作資料夾 (WAP) ](deploy-work-folders-adfs-overview.md)<br />-   [工作資料夾測試實驗室部署](https://techcommunity.microsoft.com/t5/storage-at-microsoft/bg-p/FileCAB) (部落格文章)<br />-   [工作資料夾伺服器 URL 的新使用者屬性](https://techcommunity.microsoft.com/t5/storage-at-microsoft/bg-p/FileCAB) (部落格文章)|
