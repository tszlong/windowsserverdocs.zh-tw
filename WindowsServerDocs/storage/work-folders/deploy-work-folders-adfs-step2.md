...
接下來，將自我簽署 AD FS 憑證匯出，以便在測試環境中安裝於下列電腦︰  
...
如果您沒有可管理私密金鑰的選項，您可能需要執行下列命令︰ `certutil -repairstore my *`  
  
## <a name="verify-that-ad-fs-is-operational"></a>請確認 AD FS 可操作  
若要確認 AD FS 是否可操作，請開啟瀏覽器視窗，然後前往 https://blueadfs.contoso.com/federationmetadata/2007-06/federationmetadata.xml 
