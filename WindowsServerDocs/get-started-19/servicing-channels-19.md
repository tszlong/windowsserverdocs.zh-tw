...
半年通道非常適合正在加快步調充分利用新作業系統功能，且專注於容器和微服務的客戶。 半年通道中的 Windows Server 產品每年會有兩次新版本發行，分別在春季和秋季推出。 在此通道中發行的每個版本都會從初始版本開始提供 18 個月的支援。
...
| 說明 | 長期維護通道 (Windows Server 2019) | 半年通道 (Windows Server) |
| -----------------------|--|--|
