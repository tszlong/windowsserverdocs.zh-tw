...
ms.locfileid: "8992541"
---
# Windows Server 2019 的新功能

本主題說明 Windows Server 2019 中的一些新功能。 Windows Server 2019 建立在 Windows Server 2016 強大基礎上，在四大主題上帶來許多創新：混合雲端、安全性、應用程式平台和超融合式基礎結構 (HCI)。 若要了解 Windows Server 版本 1809 的新功能，請參閱 [Windows Server 版本 1809 的新功能](../get-started/whats-new-in-windows-server-1809.md)。

## 一般

### 桌面體驗

因為 Windows Server 2019 是長期維護通道 (LTSC) 發行，所以包含<b>桌面體驗</b>。 (Windows Server 版本 1709、Windows Server 版本 1803 或 Windows Server 版本 1809 不包含此項目，因為半年通道 \(SAC\) 發行不包含桌面體驗設計；它們完全是 Server Core 和 Nano Server 容器映像發行版)。和 Windows Server 2016 一樣，在安裝作業系統期間您可以選擇 Server Core 安裝或含桌面體驗的伺服器安裝。
...
- **改善應用程式相容性**
    ...
    將 Windows 應用程式容器化變得更容易：已提高現有 *windowsservercore* 映像的應用程式相容性。 對於需相依於其他 API 的應用程式，目前有第三個基本映像：*windows*。
