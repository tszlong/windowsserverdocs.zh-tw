...
## <a name="BKMK_ConfigAD"></a>2.1。 設定其他 Active Directory 網站  
...
### <a name="DCMaintandDowntime"></a>網域控制站維護與停機時間  
...
#### <a name="TransferPDC"></a>若要轉移 PDC 模擬器角色  
...
### <a name="ChangeTwoDCs"></a>變更兩個或多個管理伺服器 Gpo 的網域控制站  
