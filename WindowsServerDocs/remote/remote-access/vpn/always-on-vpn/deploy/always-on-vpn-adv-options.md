...
- [NPS Proxy 伺服器負載平衡](../../../../../networking/technologies/nps/nps-manage-proxy-lb.md)：遠端驗證撥入使用者服務 (RADIUS) 用戶端，也就是網路存取伺服器，例如虛擬私人網路 (VPN) 伺服器和無線存取點、建立連線要求，並將它們傳送至 RADIUS 伺服器（例如 NPS）。 在某些情況下，NPS 伺服器可能會一次收到太多連線要求，因而導致效能降低或超載。
...
- [Vpn 安全性功能](/windows/access-protection/vpn/vpn-security-features)：本主題提供鎖定 VPN 的 vpn 安全性指導方針、Windows 資訊保護 (WIP) 與 VPN 整合，以及流量篩選器。
...
- [Tpm 金鑰證明](../../../../../identity/ad-ds/manage/component-updates/tpm-key-attestation.md)：本主題提供可信賴平臺模組 (tpm) 和部署 tpm 金鑰證明步驟的總覽。 您也可以尋找疑難排解資訊和解決問題的步驟。
