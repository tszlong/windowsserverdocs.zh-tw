...
ms.locfileid: "59885269"
---
# <a name="step-7-optional-conditional-access-for-vpn-connectivity-using-azure-ad"></a>步驟 7. （選擇性）使用 Azure AD 的 VPN 連線能力的條件式存取

&#171;  [**前一個：** 步驟 6.設定 Windows 10 用戶端一律開啟 VPN 連線](always-on-vpn/deploy/vpn-deploy-client-vpn-connections.md)<br>
&#187;[ **下一步:** 步驟 7.1.設定 EAP-TLS 要略過憑證撤銷清單 (CRL) 檢查](vpn-config-eap-tls-to-ignore-crl-checking.md)
...
## <a name="step-71-configure-eap-tls-to-ignore-certificate-revocation-list-crl-checkingvpn-config-eap-tls-to-ignore-crl-checkingmd"></a>[7.1 的步驟。設定 EAP-TLS 要略過憑證撤銷清單 (CRL) 檢查](vpn-config-eap-tls-to-ignore-crl-checking.md)
...
## <a name="step-72-create-root-certificates-for-vpn-authentication-with-azure-advpn-create-root-cert-for-vpn-auth-azure-admd"></a>[7.2 的步驟。使用 Azure AD 中建立 VPN 驗證的根的憑證](vpn-create-root-cert-for-vpn-auth-azure-ad.md)
...
## <a name="step-73-configure-the-conditional-access-policyvpn-config-conditional-access-policymd"></a>[7.3 的步驟。設定條件式存取原則](vpn-config-conditional-access-policy.md)
...
## <a name="step-74-deploy-conditional-access-root-certificates-to-on-premises-advpn-deploy-cond-access-root-cert-to-on-premise-admd"></a>[7.4 的步驟。將條件式存取的根憑證部署至內部部署 AD](vpn-deploy-cond-access-root-cert-to-on-premise-ad.md)
...
## <a name="step-75-create-oma-dm-based-vpnv2-profiles-to-windows-10-devicesvpn-create-oma-dm-based-vpnv2-profilesmd"></a>[步驟 7.5。建立 OMA DM 基礎 VPNv2 設定檔到 Windows 10 裝置](vpn-create-oma-dm-based-vpnv2-profiles.md)
...
[7.1 的步驟。設定 EAP-TLS 要略過憑證撤銷清單 (CRL) 檢查](vpn-config-eap-tls-to-ignore-crl-checking.md):在此步驟中，您必須加入**IgnoreNoRevocationCheck**並將它設定為允許用戶端驗證憑證不含 CRL 發佈點時。 根據預設，IgnoreNoRevocationCheck 設為 0 （停用）。
