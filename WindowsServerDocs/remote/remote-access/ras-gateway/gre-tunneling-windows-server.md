...
GRE 通道會公開為 S2S 介面中的其他通訊協定。 它的執行方式類似于下列網路日誌中所述的 IPSec S2S 通道： [Windows Server 2012 R2 的多租使用者站對站（S2S） VPN 閘道](https://techcommunity.microsoft.com/t5/networking-blog/bg-p/NetworkingBlog)  
