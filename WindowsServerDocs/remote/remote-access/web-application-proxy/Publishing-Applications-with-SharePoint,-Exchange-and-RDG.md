...
|Exchange ActiveSync|傳遞<br/> 使用 HTTP 基本授權通訊協定的 AD FS|| 如需詳細資訊，請參閱： https://docs.microsoft.com/windows-server/remote/remote-access/web-application-proxy/publishing-applications-using-ad-fs-preauthentication 
...
-   [疑難排解 Web 應用程式 Proxy](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn770156(v=ws.11))  
