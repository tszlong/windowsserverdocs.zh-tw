...
**低端 Perf：750用戶端，70/30 分割，84.17 Mb/秒輸送量：**  
...
|**低終端硬體。 562 Teredo 用戶端。 188 IPHTTPS 用戶端。**|47.7472542|84.3|119.13|1502.05|1502.1|26.27%|  
|**低終端硬體。 562 Teredo 用戶端。 188 IPHTTPS 用戶端。**|46.3889778|84.146|118.73|1501.25|1501.2|25.90%|  
|**低終端硬體。 562 Teredo 用戶端。 188 IPHTTPS 用戶端。**|45.113082|84.0494|118.43|1546.14|1546.1|25.68%|  
...
|-|-|-|-|-|-|-|  
|**案例**|**CPUAvg （從計數器）**|**Mbit/s （Corp 端）**|**Mbit/s （網際網路端）**|**現用 QMSA**|**現用 MMSA**|**記憶體使用率（4 Gb 系統）**|  
|**低終端硬體。 700 Teredo 用戶端。 300 IPHTTPS 用戶端。**|51.28406247|78.6432|113.19|2002.42|1502.1|25.59%|  
|**低終端硬體。 700 Teredo 用戶端。 300 IPHTTPS 用戶端。**|51.06993128|78.6402|113.22|2001.4|1501.2|30.87%|  
|**低終端硬體。 700 Teredo 用戶端。 300 IPHTTPS 用戶端。**|49.75235617|78.6387|113.2|2002.6|1546.1|30.66%|  
...
|-|-|-|-|-|-|-|  
|**案例**|**CPUAvg （從計數器）**|**Mbit/s （Corp 端）**|**Mbit/s （網際網路端）**|**現用 QMSA**|**現用 MMSA**|**記憶體使用率（4 Gb 系統）**|  
|**低終端硬體。 700 Teredo 用戶端。 300 IPHTTPS 用戶端。**|59.81640675|108.305|153.14|2001.64|2001.6|24.38%|  
|**低終端硬體。 700 Teredo 用戶端。 300 IPHTTPS 用戶端。**|59.46473798|110.969|157.53|2005.22|2005.2|28.72%|  
|**低終端硬體。 700 Teredo 用戶端。 300 IPHTTPS 用戶端。**|57.89089768|108.305|153.14|1999.53|2018.3|24.38%|  
...
|-|-|-|-|-|-|-|  
|**案例**|**CPUAvg （從計數器）**|**Mbit/s （Corp 端）**|**Mbit/s （網際網路端）**|**現用 QMSA**|**現用 MMSA**|**記憶體使用率（4 Gb 系統）**|  
|**高階硬體。 1050 Teredo 用戶端。 450 IPHTTPS 用戶端。**|51.712437|157.029|216.29|3000.31|3046|21.58%|  
|**高階硬體。 1050 Teredo 用戶端。 450 IPHTTPS 用戶端。**|48.86020205|151.012|206.53|3002.86|3045.3|21.15%|  
|**高階硬體。 1050 Teredo 用戶端。 450 IPHTTPS 用戶端。**|52.23979519|155.511|213.45|3001.15|3002.9|22.90%|  
|**高階硬體。 1050 Teredo 用戶端。 450 IPHTTPS 用戶端。**|51.26269767|155.09|212.92|3000.74|3002.4|22.91%|  
|**高階硬體。 1050 Teredo 用戶端。 450 IPHTTPS 用戶端。**|50.15751307|154.772|211.92|3000.9|3002.1|22.93%|  
|**高階硬體。 1050 Teredo 用戶端。 450 IPHTTPS 用戶端。**|49.83665607|145.994|201.92|3000.51|3006|22.03%|  
