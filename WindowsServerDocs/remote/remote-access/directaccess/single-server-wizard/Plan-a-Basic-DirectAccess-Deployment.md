...
1.  [步驟 1：規劃基本 DirectAccess 基礎結構 @ no__t-0-規劃網路和伺服器拓撲、防火牆設定、憑證需求、DNS 和 Active Directory。  
  
2.  [步驟 2：規劃基本 DirectAccess 部署 @ no__t-0-規劃用戶端和伺服器部署。  
