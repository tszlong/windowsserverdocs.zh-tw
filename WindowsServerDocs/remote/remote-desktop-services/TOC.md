...
### [RDS 的新功能](rds-whats-new.md)
### [RDS 支援的組態](rds-supported-config.md)
### [Windows10 VDI 支援的安全性組態](rds-vdi-supported-config.md)
### [規劃遠端桌面服務的海報](rds-poster.md)
### [遠端桌面服務主機合作夥伴](rds-hosting-partners.md)
...
### [桌面主機參考架構](Desktop-Hosting-Reference-Architecture.md)
#### [遠端桌面服務架構](Desktop-hosting-logical-architecture.md)
#### [桌面主機服務](Desktop-hosting-service.md)
#### [遠端桌面服務角色](rds-roles.md)
#### [桌面主機的 Azure 服務與考量](Azure-services-and-considerations-for-desktop-hosting.md)
## [建置和部署](rds-build-and-deploy.md)
### [使用 ARM 和 Azure Marketplace 部署概念證明 RDS 環境](rds-in-azure.md)
### [將遠端桌面服務部署移轉至 WindowsServer 2016](migrate-rds-role-services.md)
### [移轉遠端桌面服務用戶端存取使用權 (RDS CAL)](migrate-rds-cals.md)
### [將遠端桌面服務部署升級至 WindowsServer 2016](upgrade-to-rds.md)
...
#### [追蹤部署中使用的 CAL](rds-track-cals.md)
...
#### [將 Azure AD Domain Services 與 RDS 部署整合](rds-azure-adds.md)
#### [使用 Azure AD 應用程式 Proxy 發佈遠端桌面](/azure/active-directory/application-proxy-publish-remote-desktop)
### 延伸 RDS 環境以用於高可用性
#### [使用 RD 工作階段主機伺服器陣列，向外延展現有的 RDS 集合](rds-scale-rdsh-farm.md)
...
#### [受管理應用程式及桌面的隱私權設定](clients/remote-privacy-settings.md)
#### [遠端桌面連線疑難排解](clients/troubleshoot-remote-desktop-connections.md)
### 適用於 Windows 的遠端桌面用戶端
#### [開始使用](clients/windows.md)
#### [Windows 用戶端的新功能](clients/windows-whatsnew.md)
### 適用於 Android 的遠端桌面用戶端
#### [開始使用](clients/remote-desktop-android.md)
#### [Android 用戶端的新功能](clients/android-whatsnew.md)
### 適用於 iOS 的遠端桌面用戶端
#### [開始使用](clients/remote-desktop-ios.md)
#### [iOS 用戶端的新功能](clients/ios-whatsnew.md)
### 適用於 Mac 的遠端桌面用戶端
#### [開始使用](clients/remote-desktop-mac.md)
#### [MacOS 用戶端的新功能](clients/mac-whatsnew.md)
### 遠端桌面用 Web 戶端
#### [存取遠端桌面 Web 用戶端](clients/remote-desktop-web-client.md)
#### [Web 用戶端的新功能](clients/web-client-whatsnew.md)
### 針對遠端桌面設定您的電腦
#### [支援的電腦](clients/remote-desktop-supported-config.md)
#### [授權您電腦的遠端桌面存取](clients/remote-desktop-allow-access.md)
#### [從網路外部授與您電腦的存取權](clients/remote-desktop-allow-outside-access.md)
