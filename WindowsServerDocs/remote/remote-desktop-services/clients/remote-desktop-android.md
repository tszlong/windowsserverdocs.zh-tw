...
3. 您也可以設定下列其他選項：
   - **易記名稱** – 您要連線之電腦的易記名稱。 您可以使用任何字串，但如果您未指定易記名稱，就會顯示電腦名稱。
...
- **協助改善遠端桌面** - 傳送匿名資料給 Microsoft。 我們將使用這項資料來改善用戶端。 您可以深入了解我們如何處理這個匿名的私人資料，請參閱[遠端桌面用戶端隱私權聲明](https://www.microsoft.com/privacystatement/RemoteApp/Default.aspx)。 根據預設，此設定為 [開啟]  。
- **顯示** - 顯示器有兩個全域設定：
