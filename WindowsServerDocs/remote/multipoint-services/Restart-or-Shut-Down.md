---
title: 重新啟動或關閉
description: 了解如何重新啟動或關閉在 MultiPoint 服務系統
ms.custom: na
...
若要安全地關閉 MultiPoint 服務系統的電腦，該電腦必須執行關機程序，該程序會關閉任何開啟的程式、關閉視窗，並關閉電腦和其相關聯的「站台」。 請不要只是拔除或按 [電源] 按鈕來關閉電腦。 您應該在工作結束後，或必須在電腦外殼內安裝新硬體時關閉您的電腦。  如果您將其他硬體加入系統，您可能也需要關閉或重新啟動伺服器。  
...
2.  在 MultiPoint 管理員 中，按一下**首頁**，然後按一下**重新啟動電腦**。  
  
## <a name="shut-down-the-computer"></a>關閉電腦  
  
1.  結束所有的使用者工作階段。 如需結束使用者工作階段的詳細資訊，請參閱[結束使用者工作階段](End-a-User-Session.md)主題。  
  
2.  在 MultiPoint 管理員 中，按一下**首頁**索引標籤，然後再按一下**關機**。  
