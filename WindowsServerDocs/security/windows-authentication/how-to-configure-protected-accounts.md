...
-   [遠端桌面的受限制系統管理員模式](http://blogs.technet.com/b/kfalde/archive/20../restricted-admin-mode-for-rdp-in-windows-8-1-2012-r2.aspx)  
...
-   拒絕 NTLM 驗證：僅可透過[NTLM 封鎖原則](https://technet.microsoft.com/library/jj865674(v=ws.10).aspx)進行設定。  
...
1.  在 [預設網域控制站原則] 中，按一下 [啟用] 以啟用 [電腦設定 | 系統管理範本 | 系統 | KDC] 中的 [宣告、複合驗證與 Kerberos 防護的金鑰發佈中心 (KDC) 用戶端支援]。  
    ...
    ![在 [預設網域控制站原則] 中，按一下 [已啟用]，以在 [電腦設定] 中啟用對宣告、複合驗證和 Kerberos 防護 * * 的 * * 金鑰發佈中心（KDC）用戶端支援 |系統管理範本 |系統 |KDC](../media/how-to-configure-protected-accounts/ADDS_ProtectAcct_EnableKDCClaims.gif)  
...
2.  按一下 [新增項目]。  
    ...
    ![新增專案](../media/how-to-configure-protected-accounts/ADDS_ProtectAcct_AddCompAddItems.png)  
