...
## <a name="BKMK_Requirements"></a>Protected Users 群組需求
...
### <a name="BKMK_ADgroup"></a>Protected Users 群組 AD 屬性
...
|預設成員|無|
|下列群組的預設成員|無|
|是否受到 ADMINSDHOLDER 保護？|無|
|是否可從預設容器放心地移出？|[是]|
|是否可將此群組的管理放心地委派給非服務系統管理員？|無|
|預設使用者權限|沒有預設使用者權限|
