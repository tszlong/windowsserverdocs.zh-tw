# [安全性和保證](security-and-assurance.yml)
...
##### [使用 VMM](/system-center/vmm/guarded-deploy-host?toc=%2fwindows-server%2fvirtualization%2ftoc.json)
...
## [提用 Windows 中的每一使用者服務](/windows/application-management/per-user-services-in-windows)
...
### [使用 Remote Credential Guard 保護遠端桌面認證](/windows/security/identity-protection/remote-credential-guard)
