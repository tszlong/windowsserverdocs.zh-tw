...
##### [驗證組態](guarded-fabric-shielded-vm/guarded-fabric-verify-hgs-configuration.md)
...
### [認證保護的新功能](credentials-protection-and-management/whats-new-in-credential-protection.md)
...
### [Kerberos 驗證的新功能](kerberos/whats-new-in-kerberos-authentication.md)
...
### [Windows10 和 WindowsServer 2016 中的 TLS 變更](tls/tls-schannel-ssp-changes-in-windows-10-and-windows-server.md)
