---
title: 租使用者的受防護 Vm-使用 Virtual Machine Manager 部署受防護的 VM
ms.custom: na
...
如果您可存取 System Center 2016-Virtual Machine Manager （VMM），您可以部署受防護的 VM，其已建立受防護的 VM 範本。 
