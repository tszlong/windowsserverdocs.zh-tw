...
您必須在執行 windows server 之前作業系統的前端和後端網域之間，于使用者帳戶網域中的所有域2012控制器上套用下列修補程式：以資源為基礎的限制委派 KDC_ERR_POLICY 失敗的環境中， (有 Windows Server 2008 R2 的網域控制站 https://support.microsoft.com/en-gb/help/2665790/resource-based-constrained-delegation-kdc-err-policy-failure-in-enviro) 。