...
- 步驟3：使用傳遞驗證來安裝 Azure 應用程式 Proxy （AAP-SCHEME）
- 步驟4：設定所需的 MDM 原則
- 步驟5：發佈共用印表機
...
4. 針對企業雲端列印服務重複3個，並提供您的企業雲端列印服務的內部 URL
    ...
    >   注意：以下所述的 HTTPs://&lt;services-電腦端點&gt;/mcs URL 應為您為 Mopria 雲端服務和（或）企業雲端列印服務所設定的外部 URL。
...
- 開啟網頁瀏覽器，並移至 HTTPs://&lt;services-機器端點&gt;/mcs/services
