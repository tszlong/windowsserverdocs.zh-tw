...
description: 子命令 MulticastTransmission 的參考主題，它會啟動映射的排程轉換傳輸。
...
，並使用[MulticastTransmission 命令](using-the-new-multicasttransmission-command.md)
和[MulticastTransmission 命令](using-the-remove-multicasttransmission-command.md)
