...
|                                       /princ<PrincipalName>                                       |                                                                                                                                                                                                                   在表單host/computer.contoso.com@CONTOSO.COM中指定主體名稱。 **警告：** 這個參數會區分大小寫。 如需詳細資訊，請參閱[備註](#BKMK_remarks)。                                                                                                                                                                                                                    |
|                                       /mapuser<UserAccount>                                       |                                                                                                                                                                                                                                                將**princ**參數所指定的 Kerberos 主體名稱對應至指定的網域帳戶。                                                                                                                                                                                                                                                |
|                                       /mapop {add&#124;set}                                        |                                                                                                                                                                             指定如何設定對應屬性。<p>-   [**新增**] 會新增指定之本機使用者名稱的值。 這是預設值。<br />-   **Set**會為指定的本機使用者名稱設定「僅限資料加密標準（DES）加密」的值。                                                                                                                                                                             |
|                                         {-&#124;+} desonly                                          |                                                                                                                                                            預設會設定 [僅限 DES 加密]。<p>-   **+** 設定僅限 DES 加密的帳戶。<br />-   **-** 針對僅限 DES 加密的帳戶釋放限制。 **重要事項：** 從 Windows 7 和 Windows Server 2008 R2 開始，Windows 預設不支援 DES。                                                                                                                                                            |
...
| /crypto {DES-CBC-CRC&#124;DES-CBC&#124;RC4-HMAC-NT&#124;AES256-SHA1&#124;AES128-SHA1&#124;全部} | 指定在 keytab 檔案中產生的金鑰：<p>-   **DES-CBC-CRC**用於相容性。<br />-   **DES--MD5**會更緊密地遵循 MIT 的執行，並用於相容性。<br />-   **RC4-HMAC-NT**採用128位加密。<br />-   **AES256-sha1**採用 AES256-CTS-HMAC-sha1-96 加密。<br />-   **AES128-sha1**採用 AES128-CTS-HMAC-sha1-96 加密。<br />-   **所有支援**的密碼編譯類型都可以使用所有狀態。 **注意：** 預設設定是以較舊的 MIT 版本為基礎。 因此， `/crypto`一定要指定。 |
|                                             /itercount                                             |                                                                                                                                                                                                                        指定用於 AES 加密的反復專案計數。 預設值是針對非 AES 加密忽略**itercount** ，並在4096設定 aes 加密。                                                                                                                                                                                                                         |
|               /ptype {KRB5_NT_PRINCIPAL&#124;KRB5_NT_SRV_INST&#124;KRB5_NT_SRV_HST}                |                                                                                                                                                                                         指定主體類型。<p>-   **KRB5_NT_PRINCIPAL**是一般主體類型（建議選項）。<br />-   **KRB5_NT_SRV_INST**是使用者服務實例。<br />-   **KRB5_NT_SRV_HST**是主機服務實例。                                                                                                                                                                                         |
|                                       /kvno<KeyversionNum>                                        |                                                                                                                                                                                                                                                                               指定金鑰版本號碼。 預設值為 1。                                                                                                                                                                                                                                                                                |
|                                         /answer {-&#124;+}                                         |                                                                                                                                                                                                                    設定背景回應模式：<p>**-** 自動使用 [否] 回應重設密碼提示。<p>**+** 使用 [是] 自動回答 [重設密碼] 提示。                                                                                                                                                                                                                     |
...
## <a name="remarks"></a><a name=BKMK_remarks></a>標記  
...
說明如何在使用者 Sample1 的目前目錄中，建立 keytab 檔案 keytab。 （您會將此檔案與未執行 Windows 作業系統的主機電腦上的 Krb5. keytab 檔案合併）。系統會針對一般主體類型的所有支援的加密類型，建立 keytab 檔案。  
