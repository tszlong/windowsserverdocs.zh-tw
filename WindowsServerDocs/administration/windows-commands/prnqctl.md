...
## <a name="remarks"></a>備註
- **Prnqctl**命令是位於%windir%\system32\ printing_Admin_Scripts 目錄中的 Visual Basic 腳本 \\ <language> 。 若要使用此命令，請在命令提示字元中輸入**cscript** ，後面接著 prnqctl 檔案的完整路徑，或將目錄變更為適當的資料夾。 例如：
  ```
