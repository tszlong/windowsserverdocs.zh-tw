---
title: list
description: List 命令的參考文章，其中顯示磁片中的磁碟分割清單、磁片中的磁片區，或 (Vhd) 的虛擬硬碟。
ms.topic: article
...
ms.locfileid: "87887524"
---
# <a name="list"></a>list

顯示磁片中的磁碟分割、磁片中的磁片區，或 (Vhd) 的虛擬硬碟清單。
...
| vdisk | 顯示已附加和/或選取的 Vhd 清單。 此命令會列出已卸離的 Vhd （如果目前已選取）;不過，在附加 VHD 之前，磁片類型會設定為 [未知]。 以星號標示 ( * ) 的 VHD 具有焦點。 |
