...
**/Info**參數會傳回作業的狀態，以及所傳輸的檔案和位元組數目。 當狀態顯示為時 `TRANSFERRED` ，表示 BITS 已成功傳送作業中的所有檔案。 您也可以新增 **/verbose**引數來取得作業的完整詳細資料，以及 **/list**或 **/監視**來取得傳送佇列中的所有作業。
