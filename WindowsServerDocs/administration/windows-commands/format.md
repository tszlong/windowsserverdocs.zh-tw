...
| /a：\<UnitSize> | 指定要在 FAT、FAT32 或 NTFS 磁片區上使用的配置單位大小。 如果您未指定 *UnitSize*，即會根據磁碟區大小進行選擇。 針對一般用途，強烈建議使用預設設定。 下列清單顯示適用於 NTFS、FAT 及 FAT32 *UnitSize* 的有效值：</br>512</br>1024</br>2048</br>4096</br>8192</br>1.6 萬</br>32 K</br>64K</br>FAT 和 FAT32 也針對大於 512 位元組的磁區大小支援 128 K 和 256 K。 |
