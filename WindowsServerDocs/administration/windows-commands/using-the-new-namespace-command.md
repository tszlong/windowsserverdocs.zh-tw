...
|/Namespace：<Namespace name>|指定命名空間的名稱。 請注意，這不是易記的名稱，而且必須是唯一的。<br /><br />-   **部署伺服器角色服務**：此選項的語法為/NAMESPACE： WDS：<Image group>/<Image name>/<Index>。 例如： **WDS： ImageGroup1/install .wim/1**<br />-   **傳輸伺服器角色服務**：此值應符合在伺服器上建立命名空間時所指定的名稱。|
