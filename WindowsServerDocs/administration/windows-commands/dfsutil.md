...
|[dfsutil 連結](dfsutil-link.md)|顯示、建立、移除或移動資料夾 \(links @ no__t-1。|
...
|[dfsutil 診斷](dfsutil-diag.md)|執行 diagnostics 或 view dfsdirs @ no__t-0dfspath。|
|[dfsutil 網域](dfsutil-domain.md)|顯示網域中的所有 domain @ no__t-0based 命名空間。|
...
如果您在命令結尾處將物件 \(such 指定為命名空間伺服器 @ no__t-1，大部分的命令會顯示物件的相關資訊，而不需要進一步的參數或命令。 例如，使用 [dfsutil Root] 命令時，您可以將命名空間根目錄附加至命令，以查看根的相關資訊。

## <a name="BKMK_Examples"></a>典型
@no__t 0Here 是您放置範例詳細描述的位置。 &gt;

```
This /is /the /example /of /calling /command /with /parameters
```

@no__t 0Here 是您放置另一個範例的詳細描述的地方。 &gt;
