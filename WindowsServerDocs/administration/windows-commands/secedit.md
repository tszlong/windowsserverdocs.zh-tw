...
|[Secedit:validate](secedit-validate.md)|可讓您驗證的安全性範本的語法。|
...
| *使用者選取名稱*.sdb |                                                                                    **位置**: %windir%\*使用者帳戶<em>\Documents\Security\Database</br></em>*建立由*<em>： 安全性設定及分析嵌入式管理單元執行</br></em>*檔案類型*<em>： 專屬</br></em>*重新整理的頻率*<em>:每當建立新的安全性範本時，就會更新。</br></em>*內容*\*:本機安全性原則和使用者建立的安全性範本。                                                                                    |
| *使用者選取名稱*.log | **位置**：使用者定義，但預設值為 %windir%\*使用者帳戶<em>\Documents\Security\Logs</br></em>*建立由*<em>:執行 / 分析和 / 設定子命令 （或使用 安全性設定及分析嵌入式管理單元）</br></em>*檔案類型*<em>： 文字</br></em>*重新整理的頻率*<em>:執行 / 分析和 / 設定子命令 （或使用 安全性設定及分析嵌入式管理單元）;覆寫。</br></em>*內容*\*:</br>1.記錄檔名稱</br>2.日期和時間</br>3.分析或調查的結果。 |
| *使用者選取名稱*.inf |                                                                                     **位置**: %windir%\*使用者帳戶<em>\Documents\Security\Templates</br></em>*建立由*<em>： 安全性範本嵌入式管理單元執行</br></em>*檔案類型*<em>： 文字</br></em>*重新整理的頻率*<em>： 每次更新時的安全性範本</br></em>*內容*\*:包含針對每個嵌入式管理單元使用選取的原則範本的資訊設定。                                                                                     |
