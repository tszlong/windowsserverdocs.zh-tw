...
description: ImageDriverPackage 的參考主題，它會將驅動程式存放區中的驅動程式套件新增至伺服器上的現有開機映射。
...
[使用 ImageDriverPackages 命令的](using-the-add-imagedriverpackages-command.md)命令列語法索引鍵
