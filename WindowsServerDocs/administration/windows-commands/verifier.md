---
title: verifier
description: 驗證器的 Windows 命令主題，它會執行驅動程式驗證器管理員。
...
|參數|描述|  
|-------|--------|  
|\<旗標 >|必須是十進位或十六進位（位的組合）中的數位：<p>-   **值：描述**<br />-   **位0：** 特殊集區檢查<br />-   **位1：** 強制 irql 檢查<br />-   **位2：** 低資源模擬<br />-   **位3：** 集區追蹤<br />-   **位4：** i/o 驗證<br />-   **位5：** 鎖死偵測<br />-   **位6：** 未使用<br />-   **位7：** DMA 驗證<br />-   **位8：** 安全性檢查<br />-   **位9：強制執行**暫止的 i/o 要求<br />-   **位10：** IRP 記錄<br />-   **位11：** 其他檢查<p>例如， **/flags 27**等同于 **/flags 0x1b**|  
