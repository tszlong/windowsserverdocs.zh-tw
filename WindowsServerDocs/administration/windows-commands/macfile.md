...
-   /server： \\ @ no__t-1 @ no__t-2指定要變更目錄的伺服器。 如果省略，則會在本機電腦上執行此操作。
-   /path： <directory>必要。 指定您要變更之目錄的路徑。 目錄必須存在。 **macfile 目錄**不會建立目錄。
-   /owner： <OwnerName> 會變更目錄的擁有者。 如果省略，則擁有者會保持不變。
...
|         參數          |                                                                                                           描述                                                                                                            |
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| /server： \\ @ no__t-1 @ no__t-2 |                                                            指定要聯結檔案的伺服器。 如果省略，則會在本機電腦上執行此操作。                                                            |
...
|               參數                |                                                                                                                                                                           描述                                                                                                                                                                            |
|----------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       /server： \\ @ no__t-1 @ no__t-2       |                                                                                                                        指定要在其上變更參數的伺服器。 如果省略，則會在本機電腦上執行此操作。                                                                                                                         |
...
|      /server： \\ @ no__t-1 @ no__t-2      |                                                                                                             指定要在其上新增、變更或移除磁片區的伺服器。 如果省略，則會在本機電腦上執行此操作。                                                                                                              |
...
```
若要新增名為 [橫向設計] 的磁片區，請在伺服器 \\ \ 木蘭上，使用 E 磁片磁碟機中的樹狀目錄，並指定來賓可以存取該磁片區，請輸入：
```
