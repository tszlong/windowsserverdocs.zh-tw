---
title: 取得裝置
description: 取得裝置的參考主題，它會抓取預先設置電腦的 Windows 部署服務資訊（也就是在 active directory 網域服務中已加入電腦帳戶的實體電腦。
...
[使用 AllDevices 命令](using-the-get-alldevices-command.md)[，透過新增裝置命令](using-the-add-device-command.md)
設定裝置
