...
## <a name="remarks"></a>備註
-   **Prndrvr**命令是位於%windir%\system32\ printing_Admin_Scripts\\ <language>目錄中的 Visual Basic 腳本。 若要使用此命令，請在命令提示字元中輸入**cscript** ，後面接著**prnmngr**檔案的完整路徑，或將目錄變更為適當的資料夾。 例如：
    ```
