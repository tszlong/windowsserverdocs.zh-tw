...
> [!NOTE]
> 此命令在 Windows 7 和 Windows Server 2008 R2 中已被取代。 不過，您可以使用 prnjobs、Windows Management Instrumentation （WMI）或 Windows PowerShell Cmdlet 來執行許多相同的工作。 如需詳細資訊，請參閱[prnjobs](prnjobs.md)、https://go.microsoft.com/fwlink/?LinkID=29991) [Windows Management Instrumentation](https://go.microsoft.com/fwlink/?LinkID=29991) （、 [Windows PowerShell](https://go.microsoft.com/fwlink/?LinkID=128426) （https://go.microsoft.com/fwlink/?LinkID=128426)和[TechNet 腳本中心](https://go.microsoft.com/fwlink/?LinkId=164635)資源庫https://go.microsoft.com/fwlink/?LinkId=164635)（）。
> ## <a name="syntax"></a>語法
> ```
...
> |              <JobNumber>               |                                             指定您想要控制的列印工作編號。 此號碼是由裝載列印工作所傳送之列印佇列的電腦所指派。 電腦將數位指派給列印工作之後，該號碼就不會指派給該電腦所裝載之任何佇列中的任何其他列印工作。 使用參數時為\\ \\ <computerName>必要。                                             |
...
>   ```
>   這個範例示範如何延遲 \Production 電腦上的\\作業編號263：
>   ```
>   Net print \\Production 263 /hold 
>   ```
>   這個範例示範如何釋放 \Production 電腦上的\\作業編號263：
>   ```
