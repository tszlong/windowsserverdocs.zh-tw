...
> [!IMPORTANT]
> 此命令不支援在執行 Windows 8、 Windows Server 2012 或更新版本的作業系統的電腦上使用。 針對這些電腦，您可以使用[TPM 管理適用於 Windows PowerShell 的 cmdlet](https://technet.microsoft.com/library/jj603116.aspx)。
...
```
下列範例說明如何使用 * * tpm * * 命令來取得 TPM 的擁有權，並設定為擁有者密碼0wnerP@ss。
```
