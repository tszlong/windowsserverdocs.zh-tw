---
title: 解除初始化-伺服器
description: 解除初始化伺服器的參考主題，這會在初始伺服器設定期間還原對伺服器所做的變更。
...
[disable](using-the-disable-server-command.md) 
 ...
 [ ](using-the-initialize-server-command.md) [ ](using-the-enable-server-command.md) [ ](subcommand-start-server.md) [ ](subcommand-set-server.md) [ ](subcommand-stop-server.md) -server 命令的命令列語法索引鍵使用 [啟用-伺服器] 命令使用 [初始化-伺服器命令] 子命令： [設定-伺服器] 子命令： [啟動-伺服器] 子命令： [停止-伺服器]
