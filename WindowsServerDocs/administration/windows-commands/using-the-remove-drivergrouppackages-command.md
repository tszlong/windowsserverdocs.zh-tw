---
title: 使用移除 DriverGroupPackages 命令
...
ms.locfileid: "59866009"
---
# <a name="using-the-remove-drivergrouppackages-command"></a>使用移除 DriverGroupPackages 命令

>適用於：Windows Server （半年通道），Windows Server 2016 中，Windows Server 2012 R2 中，Windows Server 2012

移除驅動程式群組的伺服器上的驅動程式套件。
## <a name="syntax"></a>語法
```
...
[使用移除 DriverGroupPackage 命令](using-the-remove-drivergrouppackage-command.md)
