...
- 如需資源記錄類型的詳細資訊，請參閱徵求意見（Rfc）1035。
  ...
  < href = 命令列語法-key.md 資料-原始來源 =-[命令列](command-line-syntax-key.md)語法索引鍵 > 命令列語法索引鍵</a> < href = nslookup querytype.md 資料-原始來源 =[nslookup 集 querytype](nslookup-set-querytype.md)> nslookup set querytype</a>
