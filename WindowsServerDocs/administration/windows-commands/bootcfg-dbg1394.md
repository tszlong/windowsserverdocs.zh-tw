...
|      參數       |                                                                                                                                           描述                                                                                                                                            |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   {ON &#124; OFF}    | 指定1394埠偵錯工具的值。<br /><br />-   **ON** -將/dbg1394 選項新增至指定的 <OSEntryLineNum>，啟用遠端偵錯程式支援。<br />-   **OFF** -從指定的 <OSEntryLineNum> 移除/dbg1394 選項，以停用遠端偵錯程式支援。 |
...
|     /ch 通道      |                                                           指定用於進行偵錯工具的通道。 有效值是介於1到64之間的整數。 如果要停用1394埠調試，請勿使用 **/ch** <Channel> 參數。                                                           |
