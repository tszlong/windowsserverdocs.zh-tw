...
description: 適用于 bootcfg dbg1394 的 Windows 命令主題，其會為指定的作業系統專案設定1394埠的偵錯工具
...
|      參數       |                                                                                                                                           描述                                                                                                                                            |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   {ON &#124; OFF}    | 指定1394埠偵錯工具的值。<p>-   **ON** -藉由將/dbg1394 選項加入至指定的 <OSEntryLineNum>，啟用遠端偵錯程式支援。<br />-   **OFF** -從指定的 <OSEntryLineNum>移除/dbg1394 選項，以停用遠端偵錯程式支援。 |
