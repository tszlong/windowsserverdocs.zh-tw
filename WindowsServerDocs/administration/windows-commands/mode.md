...
|  參數  |                                                                                                                                                                                     描述                                                                                                                                                                                     |
|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Com @ no__t-0M > [：]  |                                                                                                                                                      指定非同步 Prncnfg vbshronous 通訊埠的編號。                                                                                                                                                      |
...
|  停止 = \<-0 >  |                                                                                  指定定義字元結尾的停止位數目：1、1.5 或2。 如果傳輸速率為110，預設值為2。 否則，預設值為1。 並非所有電腦都支援值1.5。                                                                                   |
|   to = {on    |                                                                                                                                                                                        停止                                                                                                                                                                                         |
|   xon = {on   |                                                                                                                                                                                        停止                                                                                                                                                                                         |
|  odsr = {on   |                                                                                                                                                                                        停止                                                                                                                                                                                         |
|  octs = {on   |                                                                                                                                                                                        停止                                                                                                                                                                                         |
...
|參數|描述|
|---------|-----------|
|lpt @ no__t-0N > [：]|必要。 指定平行埠。 *N*的有效值在1到3的範圍內。|
|com @ no__t-0M > [：]|必要。 指定序列埠。 *M*的有效值為1到4的範圍。|
|/?|在命令提示字元顯示說明。|
...
|參數|描述|
|---------|-----------|
|\<Device >|必要。 指定您要選取字碼頁的裝置。 CON 是唯一有效的裝置名稱。|
