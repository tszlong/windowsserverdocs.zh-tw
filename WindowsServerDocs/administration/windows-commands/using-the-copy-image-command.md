---
title: 複製映射
description: 複製映射的 Windows 命令主題，它會複製相同映射群組內的影像。
...
使用 [[匯出](using-the-export-image-command.md)映射] 命令
使用 [匯[入映射]](using-the-get-image-command.md)命令
