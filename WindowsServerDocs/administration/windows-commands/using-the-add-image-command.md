---
title: 新增-映射
description: 適用于新增映射的 Windows 命令主題，它會將影像新增至 Windows 部署服務伺服器。
...
ms.locfileid: "80831971"
---
# <a name="add-image"></a>新增-映射

>適用於：Windows Server (半年通道)、Windows Server 2016、Windows Server 2012 R2、Windows Server 2012

將影像新增至 Windows 部署服務伺服器。 如需如何使用此命令的範例，請參閱[範例](#BKMK_examples)。
...
使用[複製映射命令](using-the-copy-image-command.md)

使用 [[匯入映射](using-the-get-image-command.md) [] 命令，](using-the-export-image-command.md)
