...
ms.locfileid: "71363745"
---
# <a name="using-the-add-image-command"></a>使用新增映射命令
...
[命令列語法索引鍵](command-line-syntax-key.md)
 ...
 [使用匯出映射命令](using-the-export-image-command.md)
[使用以映射命令](using-the-get-image-command.md)
[ 使用移除影像命令](using-the-remove-image-command.md)
