---
title: dfsrmig
description: Drsrmig 的參考主題，可將 SYSvol 複寫從檔案複寫服務（FRS）遷移至分散式檔案系統（DFS）複寫、提供有關遷移進度的資訊，以及修改 active directory 網域服務（AD DS）物件以支援遷移。
