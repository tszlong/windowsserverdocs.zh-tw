...
|               <VolumePath>                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       指定磁碟機名稱，後面接著冒號或格式的 GUID**磁碟區 {** <em>GUID</em> **}** 。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
|              /l [<log file>]              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                  指定記錄檔寫入資訊的位置。<br /><br />如果 **/l**未指定參數，所有的資訊會寫入至預設的記錄檔：<br /><br />**%temp%\8dot3_removal_log@(** <em>GMT YYYY-MM-DD HH-MM-SS</em> **).log**                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
