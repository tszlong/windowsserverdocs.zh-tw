...
|                            參數                             |                                                                                                                                                                                                                                                                                                                                                              描述                                                                                                                                                                                                                                                                                                                                                              |
|------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                    {ON &#124; OFF&#124; edit}                    | 指定緊急管理服務重新導向的值。<br /><br />**ON** -針對指定的 <OSEntryLineNum> 啟用遠端輸出。 將/redirect 選項加入至指定的 <OSEntryLineNum>，並將 [重新導向 = com @ no__t-1] 設定新增至 [開機載入器] 區段。 Com @ no__t-0 的值是由 **/port**參數所設定。<br /><br />**OFF** -停用輸出至遠端電腦。 從 [開機載入器] 區段中指定的 <OSEntryLineNum> 和 [重新導向 = com @ no__t-1] 設定中移除/redirect 選項。<br /><br />**編輯**-藉由變更 [開機載入器] 區段中的 [重新導向 = com @ no__t-1] 設定，允許變更埠設定。 Com @ no__t-0 的值會重設為 **/port**參數所指定的值。 |
