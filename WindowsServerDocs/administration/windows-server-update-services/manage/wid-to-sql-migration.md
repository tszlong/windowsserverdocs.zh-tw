...
1. 以滑鼠右鍵按一下 [ **SUSDB**工作]， - &gt; **Tasks** - &gt; 再按一下 [卸**離**]： ![ image1](images/image1.png)
...
> [!IMPORTANT]
> 如果 SQL 實例位於與 WSUS 不同的電腦上，則應該以 **[FQDN] \\ [WSUSComputerName] $** 的格式列出 WSUS 伺服器的電腦帳戶。  如果沒有，則可以使用下列步驟來新增它，將**nt AUTHORITY\NETWORK SERVICE**取代為 WSUS 伺服器的電腦帳戶 (**[FQDN] \\ [WSUSComputerName] $**) 這會是將許可權授與**NT AUTHORITY\NETWORK SERVICE**的***額外***許可權
