---
title: 步驟 3-核准和部署 WSUS 更新
description: Windows Server Update Service (WSUS) 主題-核准和部署 WSUS 的更新是部署 WSUS 的程序有四個步驟中的步驟三
...
ms.locfileid: "59841289"
---
# <a name="step-3-approve-and-deploy-updates-in-wsus"></a>步驟 3：核准和部署 WSUS 更新
...
|[3.3.使用 WSUS 報告檢閱安裝更新](3-approve-and-deploy-updates-in-wsus.md#BKM_3.3.)|使用 WSUS 報告功能檢閱已經安裝的更新、接收這些更新的電腦及其他詳細資料。|
...
4.  在 **新增規則**，請在**步驟 1： 選取屬性**，選取下列任何單一選項的組合：
...
5.  在 **步驟 2： 編輯屬性**，每個列出的選項，按一下，然後選取 適用於每個選項。

6.  在 **步驟 3:指定的名稱**，輸入您的規則的名稱，然後按一下**確定**。
