...
|工作|描述|
|----|--------|
|[1.1.檢查考量及系統需求](plan-your-wsus-deployment.md#BKMK_1.1)|檢查考量及系統需求清單，確保您已準備好部署 WSUS 所需的所有硬體及軟體。|
|[1.2.選擇 WSUS 部署案例](plan-your-wsus-deployment.md#BKMK_1.2)|決定要使用哪個 WSUS 部署案例。|
|[1.3.選擇 WSUS 儲存策略](plan-your-wsus-deployment.md#BKMK_1.3.)|決定哪個 WSUS 儲存策略最適合您的部署。|
|[1.4.選擇 WSUS 更新語言](plan-your-wsus-deployment.md#BKMK_1.4.)|決定要安裝哪種 WSUS 更新語言。|
|[1.5.規劃 WSUS 電腦群組](plan-your-wsus-deployment.md#BKMK_1.5)|規劃部署將使用的 WSUS 電腦群組方式。|
|[1.6.規劃 WSUS 效能考量：背景智慧型傳送服務](plan-your-wsus-deployment.md#BKMK_1.6.)|規劃 WSUS 設計以取得最佳效能。|
|[1.7.規劃自動更新設定](plan-your-wsus-deployment.md#BKMK_1.7.)|規劃如何針對您的案例設定自動更新設定。|

## <a name="BKMK_1.1"></a>1.1. 檢查考量及系統需求
...
## <a name="BKMK_1.2"></a>1.2. 選擇 WSUS 部署案例
...
## <a name="BKMK_1.3."></a>1.3. 選擇 WSUS 儲存策略
...
> [!NOTE]
> Windows Server 2012 中引進了 Windows 內部資料庫 (WID)。
...
#### <a name="remote-storage-on-microsoft-update-servers"></a>Microsoft Update 伺服器上的遠端儲存體
...
## <a name="BKMK_1.4."></a>1.4. 選擇 WSUS 更新語言
...
## <a name="BKMK_1.5"></a>1.5. 規劃 WSUS 電腦群組
...
### <a name="BKMK_1.6.Network"></a>網路設定
...
### <a name="BKMK_1.6.Deferred"></a>延後的下載
...
### <a name="BKMK_1.6.Installation"></a>安裝
...
### <a name="BKMK_1.6.LargeUpdates"></a>大型更新部署
...
### <a name="BKMK_1.6.BITS"></a>背景智慧型傳送服務
...
## <a name="BKMK_1.7."></a>1.7. 規劃自動更新設定
