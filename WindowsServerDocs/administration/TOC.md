...
## [使用 Windows Admin Center 準備您的環境 (新功能！)](../manage/windows-admin-center/overview.md)
...
#### [使用 Passthrough 驗證來部署 Windows Server 混合式雲端列印](hybrid-cloud-print/hybrid-cloud-print-deploy-passthrough.md)
...
##### [Configure Features on Demand in WindowsServer](server-manager/configure-features-on-demand-in-windows-server.md)
...
#### [部署 WindowsServer Update Services](windows-server-update-services/deploy/deploy-windows-server-update-services.md)
...
#### [使用 WindowsServer Update Services 進行更新管理](windows-server-update-services/manage/update-management-with-windows-server-update-services.md)
##### [更新同步處理設定](windows-server-update-services/manage/setting-up-update-synchronizations.md)
...
##### [WSUS 訊息和疑難排解秘訣](windows-server-update-services/manage/wsus-messages-and-troubleshooting-tips.md)
...
#### [常見問題](..\manage\system-insights\faq.md)
