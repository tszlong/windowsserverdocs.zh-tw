...
2.  在詳細資料窗格中，按兩下包含您要新增成員之群組的資料夾。
    ...
    -   Active Directory*包含群組*/*網域節點*/資料夾的**使用者和電腦**
...
-   [Active Directory Domain Services](https://technet.microsoft.com/library/hh831484.aspx)在 https://technet.microsoft.com/library/hh831484.aspx的總覽。
...
-   [動態主機設定通訊協定（DHCP）總覽](https://technet.microsoft.com/library/hh831825.aspx)的 https://technet.microsoft.com/library/hh831825.aspx。
