...
1.  藉由變更** >><< **以特定值（例如： VHD 映射名稱、網路控制器 REST 名稱、vSwitch 名稱等等）來自訂 SDNExpress\scripts\TenantConfig.psd1 檔案，如先前在 FabricConfig.psd1 檔案中所定義）
