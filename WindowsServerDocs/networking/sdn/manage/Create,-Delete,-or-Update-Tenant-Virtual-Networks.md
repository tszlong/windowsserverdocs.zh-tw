...
4.  (選擇性) 將先前建立的 Acl 新增至虛擬子網，或為租使用者新增閘道連線能力。
...
當您執行下列範例腳本時，已更新的資源會直接放在具有相同資源識別碼的網路控制卡。 如果您的租使用者想要將 (24.30.2.0/24) 的新虛擬子網新增至其虛擬網路，您或 Contoso 系統管理員可以使用下列腳本。
