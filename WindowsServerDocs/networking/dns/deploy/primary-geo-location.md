...
##  <a name="bkmk_example"></a>以地理位置為基礎的流量管理範例
...
##  <a name="bkmk_works"></a>DNS 名稱解析程式的運作方式  
...
##  <a name="bkmk_config"></a>如何設定以地理位置為基礎的查詢回應的 DNS 原則  
